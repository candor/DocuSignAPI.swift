...
public final class RecipientSignatureProviderOptions: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        cpfNumber = try container.decodeIfPresent(String.self, forKey: .cpfNumber)
        cpfNumberMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .cpfNumberMetadata)
        oneTimePassword = try container.decodeIfPresent(String.self, forKey: .oneTimePassword)
        oneTimePasswordMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .oneTimePasswordMetadata)
        signerRole = try container.decodeIfPresent(String.self, forKey: .signerRole)
        signerRoleMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .signerRoleMetadata)
        sms = try container.decodeIfPresent(String.self, forKey: .sms)
        smsMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .smsMetadata)
    }
}

extension RecipientSignatureProviderOptions: Hashable {
