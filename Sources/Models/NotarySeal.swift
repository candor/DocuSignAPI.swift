...
/**  */
public final class NotarySeal: Content {
    /**  */
...
extension NotarySeal: Hashable {
    public static func == (lhs: NotarySeal, rhs: NotarySeal) -> Bool {
