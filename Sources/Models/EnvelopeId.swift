...
public final class EnvelopeId: Content {
    /**  */
...
extension EnvelopeId: Hashable {
    public static func == (lhs: EnvelopeId, rhs: EnvelopeId) -> Bool {
