...
/**  */
public final class EnvelopeHtmlDefinitions: Content {
...
extension EnvelopeHtmlDefinitions: Hashable {
    public static func == (lhs: EnvelopeHtmlDefinitions, rhs: EnvelopeHtmlDefinitions) -> Bool {
