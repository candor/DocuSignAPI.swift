...
public final class AccountPasswordRules: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        expirePassword = try container.decodeIfPresent(String.self, forKey: .expirePassword)
        expirePasswordDays = try container.decodeIfPresent(String.self, forKey: .expirePasswordDays)
        expirePasswordDaysMetadata = try container.decodeIfPresent(AccountPasswordExpirePasswordDays.self, forKey: .expirePasswordDaysMetadata)
        lockoutDurationMinutes = try container.decodeIfPresent(String.self, forKey: .lockoutDurationMinutes)
        lockoutDurationMinutesMetadata = try container.decodeIfPresent(AccountPasswordLockoutDurationMinutes.self, forKey: .lockoutDurationMinutesMetadata)
        lockoutDurationType = try container.decodeIfPresent(String.self, forKey: .lockoutDurationType)
        lockoutDurationTypeMetadata = try container.decodeIfPresent(AccountPasswordLockoutDurationType.self, forKey: .lockoutDurationTypeMetadata)
        minimumPasswordAgeDays = try container.decodeIfPresent(String.self, forKey: .minimumPasswordAgeDays)
        minimumPasswordAgeDaysMetadata = try container.decodeIfPresent(AccountPasswordMinimumPasswordAgeDays.self, forKey: .minimumPasswordAgeDaysMetadata)
        minimumPasswordLength = try container.decodeIfPresent(String.self, forKey: .minimumPasswordLength)
        minimumPasswordLengthMetadata = try container.decodeIfPresent(AccountMinimumPasswordLength.self, forKey: .minimumPasswordLengthMetadata)
        ...
        passwordStrengthType = try container.decodeIfPresent(String.self, forKey: .passwordStrengthType)
        passwordStrengthTypeMetadata = try container.decodeIfPresent(AccountPasswordStrengthType.self, forKey: .passwordStrengthTypeMetadata)
        questionsRequired = try container.decodeIfPresent(String.self, forKey: .questionsRequired)
        questionsRequiredMetadata = try container.decodeIfPresent(AccountPasswordQuestionsRequired.self, forKey: .questionsRequiredMetadata)
    }
}

extension AccountPasswordRules: Hashable {
