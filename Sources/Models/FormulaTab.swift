...
public final class FormulaTab: Content {
    /**  */
    ...
    public var formulaMetadata: PropertyMetadata?
    ...
    public var hiddenMetadata: PropertyMetadata?
    ...
    public var isPaymentAmount: String?
    public var isPaymentAmountMetadata: PropertyMetadata?
    ...
    public var roundDecimalPlaces: String?
    public var roundDecimalPlacesMetadata: PropertyMetadata?
    ...
    public var senderRequired: String?
    public var senderRequiredMetadata: PropertyMetadata?
    ...
    public var validationMessageMetadata: PropertyMetadata?
    /** A regular expression used to validate input for the tab. */
    public var validationPattern: String?
    public var validationPatternMetadata: PropertyMetadata?
    ...
    public init(anchorAllowWhiteSpaceInCharacters: String? = nil, anchorAllowWhiteSpaceInCharactersMetadata: PropertyMetadata? = nil, anchorCaseSensitive: String? = nil, anchorCaseSensitiveMetadata: PropertyMetadata? = nil, anchorHorizontalAlignment: String? = nil, anchorHorizontalAlignmentMetadata: PropertyMetadata? = nil, anchorIgnoreIfNotPresent: String? = nil, anchorIgnoreIfNotPresentMetadata: PropertyMetadata? = nil, anchorMatchWholeWord: String? = nil, anchorMatchWholeWordMetadata: PropertyMetadata? = nil, anchorString: String? = nil, anchorStringMetadata: PropertyMetadata? = nil, anchorTabProcessorVersion: String? = nil, anchorTabProcessorVersionMetadata: PropertyMetadata? = nil, anchorUnits: String? = nil, anchorUnitsMetadata: PropertyMetadata? = nil, anchorXOffset: String? = nil, anchorXOffsetMetadata: PropertyMetadata? = nil, anchorYOffset: String? = nil, anchorYOffsetMetadata: PropertyMetadata? = nil, bold: String? = nil, boldMetadata: PropertyMetadata? = nil, concealValueOnDocument: String? = nil, concealValueOnDocumentMetadata: PropertyMetadata? = nil, conditionalParentLabel: String? = nil, conditionalParentLabelMetadata: PropertyMetadata? = nil, conditionalParentValue: String? = nil, conditionalParentValueMetadata: PropertyMetadata? = nil, customTabId: String? = nil, customTabIdMetadata: PropertyMetadata? = nil, disableAutoSize: String? = nil, disableAutoSizeMetadata: PropertyMetadata? = nil, documentId: String? = nil, documentIdMetadata: PropertyMetadata? = nil, errorDetails: ErrorDetails? = nil, font: String? = nil, fontColor: String? = nil, fontColorMetadata: PropertyMetadata? = nil, fontMetadata: PropertyMetadata? = nil, fontSize: String? = nil, fontSizeMetadata: PropertyMetadata? = nil, formOrder: String? = nil, formOrderMetadata: PropertyMetadata? = nil, formPageLabel: String? = nil, formPageLabelMetadata: PropertyMetadata? = nil, formPageNumber: String? = nil, formPageNumberMetadata: PropertyMetadata? = nil, formula: String? = nil, formulaMetadata: PropertyMetadata? = nil, height: String? = nil, heightMetadata: PropertyMetadata? = nil, hidden: String? = nil, hiddenMetadata: PropertyMetadata? = nil, isPaymentAmount: String? = nil, isPaymentAmountMetadata: PropertyMetadata? = nil, italic: String? = nil, italicMetadata: PropertyMetadata? = nil, localePolicy: LocalePolicyTab? = nil, locked: String? = nil, lockedMetadata: PropertyMetadata? = nil, maxLength: String? = nil, maxLengthMetadata: PropertyMetadata? = nil, mergeField: MergeField? = nil, mergeFieldXml: String? = nil, name: String? = nil, nameMetadata: PropertyMetadata? = nil, originalValue: String? = nil, originalValueMetadata: PropertyMetadata? = nil, pageNumber: String? = nil, pageNumberMetadata: PropertyMetadata? = nil, paymentDetails: PaymentDetails? = nil, recipientId: String? = nil, recipientIdGuid: String? = nil, recipientIdGuidMetadata: PropertyMetadata? = nil, recipientIdMetadata: PropertyMetadata? = nil, requireAll: String? = nil, requireAllMetadata: PropertyMetadata? = nil, required: String? = nil, requiredMetadata: PropertyMetadata? = nil, requireInitialOnSharedChange: String? = nil, requireInitialOnSharedChangeMetadata: PropertyMetadata? = nil, roundDecimalPlaces: String? = nil, roundDecimalPlacesMetadata: PropertyMetadata? = nil, senderRequired: String? = nil, senderRequiredMetadata: PropertyMetadata? = nil, shared: String? = nil, sharedMetadata: PropertyMetadata? = nil, smartContractInformation: SmartContractInformation? = nil, status: String? = nil, statusMetadata: PropertyMetadata? = nil, tabGroupLabels: [String]? = nil, tabGroupLabelsMetadata: PropertyMetadata? = nil, tabId: String? = nil, tabIdMetadata: PropertyMetadata? = nil, tabLabel: String? = nil, tabLabelMetadata: PropertyMetadata? = nil, tabOrder: String? = nil, tabOrderMetadata: PropertyMetadata? = nil, tabType: String? = nil, tabTypeMetadata: PropertyMetadata? = nil, templateLocked: String? = nil, templateLockedMetadata: PropertyMetadata? = nil, templateRequired: String? = nil, templateRequiredMetadata: PropertyMetadata? = nil, tooltip: String? = nil, toolTipMetadata: PropertyMetadata? = nil, underline: String? = nil, underlineMetadata: PropertyMetadata? = nil, validationMessage: String? = nil, validationMessageMetadata: PropertyMetadata? = nil, validationPattern: String? = nil, validationPatternMetadata: PropertyMetadata? = nil, value: String? = nil, valueMetadata: PropertyMetadata? = nil, width: String? = nil, widthMetadata: PropertyMetadata? = nil, xPosition: String? = nil, xPositionMetadata: PropertyMetadata? = nil, yPosition: String? = nil, yPositionMetadata: PropertyMetadata? = nil) {
        ...
        self.roundDecimalPlacesMetadata = roundDecimalPlacesMetadata
        self.senderRequired = senderRequired
        self.senderRequiredMetadata = senderRequiredMetadata
        self.shared = shared
        ...
        self.validationMessageMetadata = validationMessageMetadata
        self.validationPattern = validationPattern
        self.validationPatternMetadata = validationPatternMetadata
        self.value = value
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case hidden
        case hiddenMetadata
        case isPaymentAmount
        case isPaymentAmountMetadata
        case italic
        case italicMetadata
        case localePolicy
        case locked
        ...
        case roundDecimalPlacesMetadata
        case senderRequired
        case senderRequiredMetadata
        case shared
        case sharedMetadata
        ...
        case validationMessageMetadata
        case validationPattern
        case validationPatternMetadata
        case value
        case valueMetadata
        case width
        case widthMetadata
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(formulaMetadata, forKey: .formulaMetadata)
        try container.encodeIfPresent(height, forKey: .height)
        try container.encodeIfPresent(heightMetadata, forKey: .heightMetadata)
        try container.encodeIfPresent(hidden, forKey: .hidden)
        try container.encodeIfPresent(hiddenMetadata, forKey: .hiddenMetadata)
        try container.encodeIfPresent(isPaymentAmount, forKey: .isPaymentAmount)
        try container.encodeIfPresent(isPaymentAmountMetadata, forKey: .isPaymentAmountMetadata)
        ...
        try container.encodeIfPresent(roundDecimalPlaces, forKey: .roundDecimalPlaces)
        try container.encodeIfPresent(roundDecimalPlacesMetadata, forKey: .roundDecimalPlacesMetadata)
        try container.encodeIfPresent(senderRequired, forKey: .senderRequired)
        try container.encodeIfPresent(senderRequiredMetadata, forKey: .senderRequiredMetadata)
        ...
        try container.encodeIfPresent(validationMessageMetadata, forKey: .validationMessageMetadata)
        try container.encodeIfPresent(validationPattern, forKey: .validationPattern)
        try container.encodeIfPresent(validationPatternMetadata, forKey: .validationPatternMetadata)
    ...
    public init(from decoder: Decoder) throws {
        ...
        concealValueOnDocumentMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .concealValueOnDocumentMetadata)
        conditionalParentLabel = try container.decodeIfPresent(String.self, forKey: .conditionalParentLabel)
        conditionalParentLabelMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .conditionalParentLabelMetadata)
        conditionalParentValue = try container.decodeIfPresent(String.self, forKey: .conditionalParentValue)
        conditionalParentValueMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .conditionalParentValueMetadata)
        customTabId = try container.decodeIfPresent(String.self, forKey: .customTabId)
        customTabIdMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .customTabIdMetadata)
        disableAutoSize = try container.decodeIfPresent(String.self, forKey: .disableAutoSize)
        disableAutoSizeMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .disableAutoSizeMetadata)
        documentId = try container.decodeIfPresent(String.self, forKey: .documentId)
        documentIdMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .documentIdMetadata)
        ...
        formOrder = try container.decodeIfPresent(String.self, forKey: .formOrder)
        formOrderMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .formOrderMetadata)
        formPageLabel = try container.decodeIfPresent(String.self, forKey: .formPageLabel)
        formPageLabelMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .formPageLabelMetadata)
        formPageNumber = try container.decodeIfPresent(String.self, forKey: .formPageNumber)
        formPageNumberMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .formPageNumberMetadata)
        formula = try container.decodeIfPresent(String.self, forKey: .formula)
        formulaMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .formulaMetadata)
        height = try container.decodeIfPresent(String.self, forKey: .height)
        heightMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .heightMetadata)
        hidden = try container.decodeIfPresent(String.self, forKey: .hidden)
        hiddenMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .hiddenMetadata)
        isPaymentAmount = try container.decodeIfPresent(String.self, forKey: .isPaymentAmount)
        isPaymentAmountMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .isPaymentAmountMetadata)
        ...
        localePolicy = try container.decodeIfPresent(LocalePolicyTab.self, forKey: .localePolicy)
        ...
        maxLengthMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .maxLengthMetadata)
        mergeField = try container.decodeIfPresent(MergeField.self, forKey: .mergeField)
        mergeFieldXml = try container.decodeIfPresent(String.self, forKey: .mergeFieldXml)
        ...
        originalValueMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .originalValueMetadata)
        ...
        paymentDetails = try container.decodeIfPresent(PaymentDetails.self, forKey: .paymentDetails)
        ...
        recipientIdGuidMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .recipientIdGuidMetadata)
        recipientIdMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .recipientIdMetadata)
        requireAll = try container.decodeIfPresent(String.self, forKey: .requireAll)
        requireAllMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .requireAllMetadata)
        ...
        requireInitialOnSharedChangeMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .requireInitialOnSharedChangeMetadata)
        roundDecimalPlaces = try container.decodeIfPresent(String.self, forKey: .roundDecimalPlaces)
        roundDecimalPlacesMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .roundDecimalPlacesMetadata)
        senderRequired = try container.decodeIfPresent(String.self, forKey: .senderRequired)
        senderRequiredMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .senderRequiredMetadata)
        shared = try container.decodeIfPresent(String.self, forKey: .shared)
        sharedMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .sharedMetadata)
        smartContractInformation = try container.decodeIfPresent(SmartContractInformation.self, forKey: .smartContractInformation)
        status = try container.decodeIfPresent(String.self, forKey: .status)
        statusMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .statusMetadata)
        tabGroupLabels = try container.decodeIfPresent([String].self, forKey: .tabGroupLabels)
        tabGroupLabelsMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .tabGroupLabelsMetadata)
        ...
        tabLabelMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .tabLabelMetadata)
        ...
        tabType = try container.decodeIfPresent(String.self, forKey: .tabType)
        tabTypeMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .tabTypeMetadata)
        templateLocked = try container.decodeIfPresent(String.self, forKey: .templateLocked)
        templateLockedMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .templateLockedMetadata)
        templateRequired = try container.decodeIfPresent(String.self, forKey: .templateRequired)
        templateRequiredMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .templateRequiredMetadata)
        tooltip = try container.decodeIfPresent(String.self, forKey: .tooltip)
        toolTipMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .toolTipMetadata)
        ...
        validationMessageMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .validationMessageMetadata)
        validationPattern = try container.decodeIfPresent(String.self, forKey: .validationPattern)
        validationPatternMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .validationPatternMetadata)
        ...
        widthMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .widthMetadata)
...
extension FormulaTab: Hashable {
    public static func == (lhs: FormulaTab, rhs: FormulaTab) -> Bool {
        lhs.anchorAllowWhiteSpaceInCharacters == rhs.anchorAllowWhiteSpaceInCharacters &&
            ...
            lhs.formulaMetadata == rhs.formulaMetadata &&
            lhs.height == rhs.height &&
            lhs.heightMetadata == rhs.heightMetadata &&
            lhs.hidden == rhs.hidden &&
            lhs.hiddenMetadata == rhs.hiddenMetadata &&
            lhs.isPaymentAmount == rhs.isPaymentAmount &&
            lhs.isPaymentAmountMetadata == rhs.isPaymentAmountMetadata &&
            ...
            lhs.paymentDetails == rhs.paymentDetails &&
            ...
            lhs.roundDecimalPlaces == rhs.roundDecimalPlaces &&
            lhs.roundDecimalPlacesMetadata == rhs.roundDecimalPlacesMetadata &&
            lhs.senderRequired == rhs.senderRequired &&
            lhs.senderRequiredMetadata == rhs.senderRequiredMetadata &&
            ...
            lhs.validationMessageMetadata == rhs.validationMessageMetadata &&
            lhs.validationPattern == rhs.validationPattern &&
            lhs.validationPatternMetadata == rhs.validationPatternMetadata &&
            lhs.value == rhs.value &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(formula?.hashValue)
        hasher.combine(formulaMetadata?.hashValue)
        hasher.combine(height?.hashValue)
        hasher.combine(heightMetadata?.hashValue)
        hasher.combine(hidden?.hashValue)
        hasher.combine(hiddenMetadata?.hashValue)
        hasher.combine(isPaymentAmount?.hashValue)
        hasher.combine(isPaymentAmountMetadata?.hashValue)
        ...
        hasher.combine(paymentDetails?.hashValue)
        ...
        hasher.combine(roundDecimalPlaces?.hashValue)
        hasher.combine(roundDecimalPlacesMetadata?.hashValue)
        hasher.combine(senderRequired?.hashValue)
        hasher.combine(senderRequiredMetadata?.hashValue)
        ...
        hasher.combine(validationMessageMetadata?.hashValue)
        hasher.combine(validationPattern?.hashValue)
        hasher.combine(validationPatternMetadata?.hashValue)
