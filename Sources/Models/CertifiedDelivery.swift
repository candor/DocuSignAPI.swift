...
public final class CertifiedDelivery: Content {
...
extension CertifiedDelivery: Hashable {
    public static func == (lhs: CertifiedDelivery, rhs: CertifiedDelivery) -> Bool {
