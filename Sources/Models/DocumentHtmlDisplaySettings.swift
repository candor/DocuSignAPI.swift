...
/**  */
public final class DocumentHtmlDisplaySettings: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        collapsibleSettings = try container.decodeIfPresent(DocumentHtmlCollapsibleDisplaySettings.self, forKey: .collapsibleSettings)
...
extension DocumentHtmlDisplaySettings: Hashable {
