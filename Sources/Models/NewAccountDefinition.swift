...
/**  */
public final class NewAccountDefinition: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        addressInformation = try container.decodeIfPresent(AccountAddress.self, forKey: .addressInformation)
        ...
        envelopePartitionId = try container.decodeIfPresent(String.self, forKey: .envelopePartitionId)
        initialUser = try container.decodeIfPresent(UserInformation.self, forKey: .initialUser)
...
extension NewAccountDefinition: Hashable {
