...
/**  */
public final class SignatureUser: Content {
    ...
    public init(isDefault: String? = nil, rights: String? = nil, userId: String? = nil, userName: String? = nil) {
...
extension SignatureUser: Hashable {
    public static func == (lhs: SignatureUser, rhs: SignatureUser) -> Bool {
