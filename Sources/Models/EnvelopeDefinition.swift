...
public final class EnvelopeDefinition: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowRecipientRecursion = try container.decodeIfPresent(String.self, forKey: .allowRecipientRecursion)
        ...
        compositeTemplates = try container.decodeIfPresent([CompositeTemplate].self, forKey: .compositeTemplates)
        ...
        eventNotification = try container.decodeIfPresent(EventNotification.self, forKey: .eventNotification)
        eventNotifications = try container.decodeIfPresent([EventNotification].self, forKey: .eventNotifications)
        ...
        templateRoles = try container.decodeIfPresent([TemplateRole].self, forKey: .templateRoles)
...
extension EnvelopeDefinition: Hashable {
