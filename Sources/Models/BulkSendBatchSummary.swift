...
/**  */
public final class BulkSendBatchSummary: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        batchUri = try container.decodeIfPresent(String.self, forKey: .batchUri)
...
extension BulkSendBatchSummary: Hashable {
