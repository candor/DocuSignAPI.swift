...
/**  */
public final class AddressInformationInput: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        addressInformation = try container.decodeIfPresent(AddressInformation.self, forKey: .addressInformation)
...
extension AddressInformationInput: Hashable {
