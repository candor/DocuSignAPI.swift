...
public final class PaymentMethodWithOptions: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        supportedOptions = try container.decodeIfPresent([String].self, forKey: .supportedOptions)
        type = try container.decodeIfPresent(String.self, forKey: .type)
    }
}

extension PaymentMethodWithOptions: Hashable {
