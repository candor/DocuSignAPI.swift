...
public final class NotaryJurisdictionList: Content {
    /** The last index position in the result set.  */
    public var endPosition: String?
    /** The URI for the next chunk of records based on the search request. It is `null` if this is the last set of results for the search.  */
    public var nextUri: String?
    /** An array of jurisdictions. */
    public var notaryJurisdictions: [NotaryJurisdiction]?
    ...
    public init(endPosition: String? = nil, nextUri: String? = nil, notaryJurisdictions: [NotaryJurisdiction]? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil) {
        self.endPosition = endPosition
        self.nextUri = nextUri
        self.notaryJurisdictions = notaryJurisdictions
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(notaryJurisdictions, forKey: .notaryJurisdictions)
    ...
    public init(from decoder: Decoder) throws {
        ...
        notaryJurisdictions = try container.decodeIfPresent([NotaryJurisdiction].self, forKey: .notaryJurisdictions)
...
extension NotaryJurisdictionList: Hashable {
    public static func == (lhs: NotaryJurisdictionList, rhs: NotaryJurisdictionList) -> Bool {
        lhs.endPosition == rhs.endPosition &&
            lhs.nextUri == rhs.nextUri &&
            lhs.notaryJurisdictions == rhs.notaryJurisdictions &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(notaryJurisdictions?.hashValue)
