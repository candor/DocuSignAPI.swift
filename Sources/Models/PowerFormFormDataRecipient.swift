...
/**  */
public final class PowerFormFormDataRecipient: Content {
    /**  */
    ...
    public init(from decoder: Decoder) throws {
        ...
        formData = try container.decodeIfPresent([NameValue].self, forKey: .formData)
        name = try container.decodeIfPresent(String.self, forKey: .name)
        recipientId = try container.decodeIfPresent(String.self, forKey: .recipientId)
    }
}

extension PowerFormFormDataRecipient: Hashable {
