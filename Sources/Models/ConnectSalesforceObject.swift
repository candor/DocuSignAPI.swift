...
public final class ConnectSalesforceObject: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        onCompleteOnly = try container.decodeIfPresent(String.self, forKey: .onCompleteOnly)
        selectFields = try container.decodeIfPresent([ConnectSalesforceField].self, forKey: .selectFields)
        sfObject = try container.decodeIfPresent(String.self, forKey: .sfObject)
        sfObjectName = try container.decodeIfPresent(String.self, forKey: .sfObjectName)
        updateFields = try container.decodeIfPresent([ConnectSalesforceField].self, forKey: .updateFields)
    }
}

extension ConnectSalesforceObject: Hashable {
