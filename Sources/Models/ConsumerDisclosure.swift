...
public final class ConsumerDisclosure: Content {
...
extension ConsumerDisclosure: Hashable {
    public static func == (lhs: ConsumerDisclosure, rhs: ConsumerDisclosure) -> Bool {
