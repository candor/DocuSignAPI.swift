...
public final class EnvelopeTransferRules: Content {
...
extension EnvelopeTransferRules: Hashable {
    public static func == (lhs: EnvelopeTransferRules, rhs: EnvelopeTransferRules) -> Bool {
