...
/**  */
public final class BulkEnvelopesResponse: Content {
    /** Reserved: TBD */
    public var bulkEnvelopeStatuses: [BulkEnvelopeStatus]?
    ...
    public init(bulkEnvelopeStatuses: [BulkEnvelopeStatus]? = nil, endPosition: String? = nil, nextUri: String? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil) {
        self.bulkEnvelopeStatuses = bulkEnvelopeStatuses
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(bulkEnvelopeStatuses, forKey: .bulkEnvelopeStatuses)
    ...
    public init(from decoder: Decoder) throws {
        ...
        bulkEnvelopeStatuses = try container.decodeIfPresent([BulkEnvelopeStatus].self, forKey: .bulkEnvelopeStatuses)
...
extension BulkEnvelopesResponse: Hashable {
    public static func == (lhs: BulkEnvelopesResponse, rhs: BulkEnvelopesResponse) -> Bool {
        lhs.bulkEnvelopeStatuses == rhs.bulkEnvelopeStatuses &&
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(bulkEnvelopeStatuses?.hashValue)
