...
public final class EnvelopeTransferRuleRequest: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        fromGroups = try container.decodeIfPresent([Group].self, forKey: .fromGroups)
        fromUsers = try container.decodeIfPresent([UserInformation].self, forKey: .fromUsers)
...
extension EnvelopeTransferRuleRequest: Hashable {
