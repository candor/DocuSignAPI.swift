...
/**  */
public final class CommissionNumber: Content {
    /**  */
...
extension CommissionNumber: Hashable {
    public static func == (lhs: CommissionNumber, rhs: CommissionNumber) -> Bool {
