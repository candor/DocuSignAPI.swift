...
public final class Workspaces: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        billableAccountId = try container.decodeIfPresent(String.self, forKey: .billableAccountId)
        callerInformation = try container.decodeIfPresent(WorkspaceUser.self, forKey: .callerInformation)
        ...
        workspaceBaseUrl = try container.decodeIfPresent(String.self, forKey: .workspaceBaseUrl)
        workspaceDescription = try container.decodeIfPresent(String.self, forKey: .workspaceDescription)
        workspaceId = try container.decodeIfPresent(String.self, forKey: .workspaceId)
        workspaceName = try container.decodeIfPresent(String.self, forKey: .workspaceName)
        workspaceUri = try container.decodeIfPresent(String.self, forKey: .workspaceUri)
    }
}

extension Workspaces: Hashable {
    public static func == (lhs: Workspaces, rhs: Workspaces) -> Bool {
