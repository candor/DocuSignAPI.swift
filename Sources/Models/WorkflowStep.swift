...
public final class WorkflowStep: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        recipientRouting = try container.decodeIfPresent(RecipientRouting.self, forKey: .recipientRouting)
        status = try container.decodeIfPresent(String.self, forKey: .status)
        triggeredDate = try container.decodeIfPresent(String.self, forKey: .triggeredDate)
        triggerOnItem = try container.decodeIfPresent(String.self, forKey: .triggerOnItem)
        workflowStepId = try container.decodeIfPresent(String.self, forKey: .workflowStepId)
    }
}

extension WorkflowStep: Hashable {
