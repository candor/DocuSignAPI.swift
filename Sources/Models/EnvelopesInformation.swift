...
public final class EnvelopesInformation: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        envelopeTransactionStatuses = try container.decodeIfPresent([EnvelopeTransactionStatus].self, forKey: .envelopeTransactionStatuses)
        folders = try container.decodeIfPresent([Folder].self, forKey: .folders)
        lastQueriedDateTime = try container.decodeIfPresent(String.self, forKey: .lastQueriedDateTime)
...
extension EnvelopesInformation: Hashable {
