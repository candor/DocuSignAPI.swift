...
public final class AccountSharedAccess: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        sharedAccess = try container.decodeIfPresent([MemberSharedItems].self, forKey: .sharedAccess)
...
extension AccountSharedAccess: Hashable {
