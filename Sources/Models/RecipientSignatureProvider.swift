...
public final class RecipientSignatureProvider: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        sealDocumentsWithTabsOnly = try container.decodeIfPresent(String.self, forKey: .sealDocumentsWithTabsOnly)
        ...
        signatureProviderNameMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .signatureProviderNameMetadata)
        signatureProviderOptions = try container.decodeIfPresent(RecipientSignatureProviderOptions.self, forKey: .signatureProviderOptions)
    }
}

extension RecipientSignatureProvider: Hashable {
