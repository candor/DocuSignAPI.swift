...
/**  */
public final class TemplateDocumentTabs: Content {
...
extension TemplateDocumentTabs: Hashable {
    public static func == (lhs: TemplateDocumentTabs, rhs: TemplateDocumentTabs) -> Bool {
