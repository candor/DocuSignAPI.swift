...
/**  */
public final class RecipientEmailNotification: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        emailBodyMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .emailBodyMetadata)
        emailSubject = try container.decodeIfPresent(String.self, forKey: .emailSubject)
        emailSubjectMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .emailSubjectMetadata)
        supportedLanguage = try container.decodeIfPresent(String.self, forKey: .supportedLanguage)
        supportedLanguageMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .supportedLanguageMetadata)
    }
}

extension RecipientEmailNotification: Hashable {
