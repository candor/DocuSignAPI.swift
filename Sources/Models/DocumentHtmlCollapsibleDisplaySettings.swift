//
// DocumentHtmlCollapsibleDisplaySettings.swift
//
...
/**  */
public final class DocumentHtmlCollapsibleDisplaySettings: Content {
    /**  */
...
extension DocumentHtmlCollapsibleDisplaySettings: Hashable {
    public static func == (lhs: DocumentHtmlCollapsibleDisplaySettings, rhs: DocumentHtmlCollapsibleDisplaySettings) -> Bool {
