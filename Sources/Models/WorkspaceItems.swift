...
public final class WorkspaceItems: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        callerAuthorization = try container.decodeIfPresent(WorkspaceUserAuthorization.self, forKey: .callerAuthorization)
        contentType = try container.decodeIfPresent(String.self, forKey: .contentType)
        created = try container.decodeIfPresent(String.self, forKey: .created)
        createdById = try container.decodeIfPresent(String.self, forKey: .createdById)
        createdByInformation = try container.decodeIfPresent(WorkspaceUser.self, forKey: .createdByInformation)
        ...
        fileUri = try container.decodeIfPresent(String.self, forKey: .fileUri)
        ...
        lastModifiedByInformation = try container.decodeIfPresent(WorkspaceUser.self, forKey: .lastModifiedByInformation)
        ...
        thumbHeight = try container.decodeIfPresent(String.self, forKey: .thumbHeight)
        thumbnail = try container.decodeIfPresent(Page.self, forKey: .thumbnail)
        thumbWidth = try container.decodeIfPresent(String.self, forKey: .thumbWidth)
        type = try container.decodeIfPresent(String.self, forKey: .type)
        uri = try container.decodeIfPresent(String.self, forKey: .uri)
        userAuthorization = try container.decodeIfPresent(WorkspaceUserAuthorization.self, forKey: .userAuthorization)
    }
}

extension WorkspaceItems: Hashable {
    public static func == (lhs: WorkspaceItems, rhs: WorkspaceItems) -> Bool {
