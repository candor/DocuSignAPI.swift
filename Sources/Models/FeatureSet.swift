...
public final class FeatureSet: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        currencyFeatureSetPrices = try container.decodeIfPresent([CurrencyFeatureSetPrice].self, forKey: .currencyFeatureSetPrices)
        envelopeFee = try container.decodeIfPresent(String.self, forKey: .envelopeFee)
        featureSetId = try container.decodeIfPresent(String.self, forKey: .featureSetId)
