...
public final class CorrectViewRequest: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        suppressNavigation = try container.decodeIfPresent(String.self, forKey: .suppressNavigation)
        viewUrl = try container.decodeIfPresent(String.self, forKey: .viewUrl)
    }
}

extension CorrectViewRequest: Hashable {
