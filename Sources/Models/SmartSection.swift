...
/**  */
public final class SmartSection: Content {
    /**  */
    ...
    public var displaySettings: SmartSectionDisplaySettings?
    ...
    public var endPosition: SmartSectionAnchorPosition?
    ...
    public var overlayTypeMetadata: PropertyMetadata?
    ...
    public var startPosition: SmartSectionAnchorPosition?
    ...
    public init(anchorAllowWhiteSpaceInCharacters: String? = nil, anchorAllowWhiteSpaceInCharactersMetadata: PropertyMetadata? = nil, anchorCaseSensitive: String? = nil, anchorCaseSensitiveMetadata: PropertyMetadata? = nil, anchorHorizontalAlignment: String? = nil, anchorHorizontalAlignmentMetadata: PropertyMetadata? = nil, anchorIgnoreIfNotPresent: String? = nil, anchorIgnoreIfNotPresentMetadata: PropertyMetadata? = nil, anchorMatchWholeWord: String? = nil, anchorMatchWholeWordMetadata: PropertyMetadata? = nil, anchorString: String? = nil, anchorStringMetadata: PropertyMetadata? = nil, anchorTabProcessorVersion: String? = nil, anchorTabProcessorVersionMetadata: PropertyMetadata? = nil, anchorUnits: String? = nil, anchorUnitsMetadata: PropertyMetadata? = nil, anchorXOffset: String? = nil, anchorXOffsetMetadata: PropertyMetadata? = nil, anchorYOffset: String? = nil, anchorYOffsetMetadata: PropertyMetadata? = nil, caseSensitive: Bool? = nil, conditionalParentLabel: String? = nil, conditionalParentLabelMetadata: PropertyMetadata? = nil, conditionalParentValue: String? = nil, conditionalParentValueMetadata: PropertyMetadata? = nil, customTabId: String? = nil, customTabIdMetadata: PropertyMetadata? = nil, displaySettings: SmartSectionDisplaySettings? = nil, documentId: String? = nil, documentIdMetadata: PropertyMetadata? = nil, endAnchor: String? = nil, endPosition: SmartSectionAnchorPosition? = nil, errorDetails: ErrorDetails? = nil, formOrder: String? = nil, formOrderMetadata: PropertyMetadata? = nil, formPageLabel: String? = nil, formPageLabelMetadata: PropertyMetadata? = nil, formPageNumber: String? = nil, formPageNumberMetadata: PropertyMetadata? = nil, height: String? = nil, heightMetadata: PropertyMetadata? = nil, locked: String? = nil, lockedMetadata: PropertyMetadata? = nil, mergeField: MergeField? = nil, mergeFieldXml: String? = nil, overlayType: String? = nil, overlayTypeMetadata: PropertyMetadata? = nil, pageNumber: String? = nil, pageNumberMetadata: PropertyMetadata? = nil, recipientId: String? = nil, recipientIdGuid: String? = nil, recipientIdGuidMetadata: PropertyMetadata? = nil, recipientIdMetadata: PropertyMetadata? = nil, removeEndAnchor: Bool? = nil, removeStartAnchor: Bool? = nil, shared: String? = nil, sharedMetadata: PropertyMetadata? = nil, smartContractInformation: SmartContractInformation? = nil, startAnchor: String? = nil, startPosition: SmartSectionAnchorPosition? = nil, status: String? = nil, statusMetadata: PropertyMetadata? = nil, tabGroupLabels: [String]? = nil, tabGroupLabelsMetadata: PropertyMetadata? = nil, tabId: String? = nil, tabIdMetadata: PropertyMetadata? = nil, tabLabel: String? = nil, tabOrder: String? = nil, tabOrderMetadata: PropertyMetadata? = nil, tabType: String? = nil, tabTypeMetadata: PropertyMetadata? = nil, templateLocked: String? = nil, templateLockedMetadata: PropertyMetadata? = nil, templateRequired: String? = nil, templateRequiredMetadata: PropertyMetadata? = nil, tooltip: String? = nil, toolTipMetadata: PropertyMetadata? = nil, width: String? = nil, widthMetadata: PropertyMetadata? = nil, xPosition: String? = nil, xPositionMetadata: PropertyMetadata? = nil, yPosition: String? = nil, yPositionMetadata: PropertyMetadata? = nil) {
        ...
        self.overlayTypeMetadata = overlayTypeMetadata
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(overlayType, forKey: .overlayType)
        try container.encodeIfPresent(overlayTypeMetadata, forKey: .overlayTypeMetadata)
    ...
    public init(from decoder: Decoder) throws {
        ...
        displaySettings = try container.decodeIfPresent(SmartSectionDisplaySettings.self, forKey: .displaySettings)
        ...
        endPosition = try container.decodeIfPresent(SmartSectionAnchorPosition.self, forKey: .endPosition)
        ...
        overlayType = try container.decodeIfPresent(String.self, forKey: .overlayType)
        overlayTypeMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .overlayTypeMetadata)
        ...
        startPosition = try container.decodeIfPresent(SmartSectionAnchorPosition.self, forKey: .startPosition)
...
extension SmartSection: Hashable {
    public static func == (lhs: SmartSection, rhs: SmartSection) -> Bool {
        lhs.anchorAllowWhiteSpaceInCharacters == rhs.anchorAllowWhiteSpaceInCharacters &&
            ...
            lhs.overlayType == rhs.overlayType &&
            lhs.overlayTypeMetadata == rhs.overlayTypeMetadata &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(overlayType?.hashValue)
        hasher.combine(overlayTypeMetadata?.hashValue)
