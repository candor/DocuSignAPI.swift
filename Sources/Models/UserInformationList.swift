...
public final class UserInformationList: Content {
    ...
    public init(endPosition: String? = nil, nextUri: String? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil, users: [UserInformation]? = nil) {
...
extension UserInformationList: Hashable {
    public static func == (lhs: UserInformationList, rhs: UserInformationList) -> Bool {
