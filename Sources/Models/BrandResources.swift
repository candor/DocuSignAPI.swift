...
public final class BrandResources: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        createdByUserInfo = try container.decodeIfPresent(UserInfo.self, forKey: .createdByUserInfo)
        createdDate = try container.decodeIfPresent(String.self, forKey: .createdDate)
        dataNotSavedNotInMaster = try container.decodeIfPresent([String].self, forKey: .dataNotSavedNotInMaster)
        modifiedByUserInfo = try container.decodeIfPresent(UserInfo.self, forKey: .modifiedByUserInfo)
        modifiedDate = try container.decodeIfPresent(String.self, forKey: .modifiedDate)
        modifiedTemplates = try container.decodeIfPresent([String].self, forKey: .modifiedTemplates)
        resourcesContentType = try container.decodeIfPresent(String.self, forKey: .resourcesContentType)
        resourcesContentUri = try container.decodeIfPresent(String.self, forKey: .resourcesContentUri)
    }
}

extension BrandResources: Hashable {
