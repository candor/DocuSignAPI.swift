...
/**  */
public final class BulkSendBatchSummaries: Content {
    /**  */
    ...
    public init(from decoder: Decoder) throws {
        ...
        batchSizeLimit = try container.decodeIfPresent(String.self, forKey: .batchSizeLimit)
        bulkBatchSummaries = try container.decodeIfPresent([BulkSendBatchSummary].self, forKey: .bulkBatchSummaries)
...
extension BulkSendBatchSummaries: Hashable {
