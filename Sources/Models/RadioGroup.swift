...
public final class RadioGroup: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        groupNameMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .groupNameMetadata)
        radios = try container.decodeIfPresent([Radio].self, forKey: .radios)
