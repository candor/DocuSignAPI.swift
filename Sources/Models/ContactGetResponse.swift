...
public final class ContactGetResponse: Content {
    /** A list of contacts. */
    ...
    public init(contacts: [Contact]? = nil, endPosition: String? = nil, nextUri: String? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil) {
...
extension ContactGetResponse: Hashable {
    public static func == (lhs: ContactGetResponse, rhs: ContactGetResponse) -> Bool {
