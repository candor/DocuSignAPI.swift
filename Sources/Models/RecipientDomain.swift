...
/**  */
public final class RecipientDomain: Content {
    /**  */
    ...
    public init(from decoder: Decoder) throws {
        ...
        recipientDomainId = try container.decodeIfPresent(String.self, forKey: .recipientDomainId)
    }
}

extension RecipientDomain: Hashable {
