...
/**  */
public final class CommissionExpiration: Content {
    /**  */
...
extension CommissionExpiration: Hashable {
    public static func == (lhs: CommissionExpiration, rhs: CommissionExpiration) -> Bool {
