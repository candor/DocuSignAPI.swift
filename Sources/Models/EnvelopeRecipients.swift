...
/** Envelope recipients */
public final class EnvelopeRecipients: Content {
...
extension EnvelopeRecipients: Hashable {
    public static func == (lhs: EnvelopeRecipients, rhs: EnvelopeRecipients) -> Bool {
