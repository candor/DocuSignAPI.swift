...
public final class BccEmailArchiveList: Content {
    /** A list of  BCC email archive configurations. */
    public var bccEmailArchives: [BccEmailArchive]?
    ...
    public init(bccEmailArchives: [BccEmailArchive]? = nil, endPosition: String? = nil, nextUri: String? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil) {
        self.bccEmailArchives = bccEmailArchives
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(bccEmailArchives, forKey: .bccEmailArchives)
    ...
    public init(from decoder: Decoder) throws {
        ...
        bccEmailArchives = try container.decodeIfPresent([BccEmailArchive].self, forKey: .bccEmailArchives)
...
extension BccEmailArchiveList: Hashable {
    public static func == (lhs: BccEmailArchiveList, rhs: BccEmailArchiveList) -> Bool {
        lhs.bccEmailArchives == rhs.bccEmailArchives &&
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(bccEmailArchives?.hashValue)
