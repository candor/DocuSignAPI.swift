...
public final class BulkSendingListSummary: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        bulkSendListId = try container.decodeIfPresent(String.self, forKey: .bulkSendListId)
...
extension BulkSendingListSummary: Hashable {
