...
public final class UserAccountManagementGranularInformation: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        canManageAccountSecuritySettings = try container.decodeIfPresent(String.self, forKey: .canManageAccountSecuritySettings)
        canManageAccountSecuritySettingsMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageAccountSecuritySettingsMetadata)
        canManageAccountSettings = try container.decodeIfPresent(String.self, forKey: .canManageAccountSettings)
        canManageAccountSettingsMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageAccountSettingsMetadata)
        canManageAdmins = try container.decodeIfPresent(String.self, forKey: .canManageAdmins)
        canManageAdminsMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageAdminsMetadata)
        canManageEnvelopeTransfer = try container.decodeIfPresent(String.self, forKey: .canManageEnvelopeTransfer)
        canManageEnvelopeTransferMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageEnvelopeTransferMetadata)
        canManageReporting = try container.decodeIfPresent(String.self, forKey: .canManageReporting)
        canManageReportingMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageReportingMetadata)
        canManageSharing = try container.decodeIfPresent(String.self, forKey: .canManageSharing)
        canManageSharingMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageSharingMetadata)
        canManageSigningGroups = try container.decodeIfPresent(String.self, forKey: .canManageSigningGroups)
        canManageSigningGroupsMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageSigningGroupsMetadata)
        canManageUsers = try container.decodeIfPresent(String.self, forKey: .canManageUsers)
        canManageUsersMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canManageUsersMetadata)
        canViewUsers = try container.decodeIfPresent(String.self, forKey: .canViewUsers)
    }
}

extension UserAccountManagementGranularInformation: Hashable {
