...
public final class AccountRoleSettings: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowAccountManagement = try container.decodeIfPresent(String.self, forKey: .allowAccountManagement)
        allowAccountManagementMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowAccountManagementMetadata)
        allowApiAccess = try container.decodeIfPresent(String.self, forKey: .allowApiAccess)
        allowApiAccessMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowApiAccessMetadata)
        allowApiAccessToAccount = try container.decodeIfPresent(String.self, forKey: .allowApiAccessToAccount)
        allowApiAccessToAccountMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowApiAccessToAccountMetadata)
        allowApiSendingOnBehalfOfOthers = try container.decodeIfPresent(String.self, forKey: .allowApiSendingOnBehalfOfOthers)
        allowApiSendingOnBehalfOfOthersMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowApiSendingOnBehalfOfOthersMetadata)
        allowApiSequentialSigning = try container.decodeIfPresent(String.self, forKey: .allowApiSequentialSigning)
        allowApiSequentialSigningMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowApiSequentialSigningMetadata)
        ...
        allowBulkSending = try container.decodeIfPresent(String.self, forKey: .allowBulkSending)
        allowBulkSendingMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowBulkSendingMetadata)
        allowDocuSignDesktopClient = try container.decodeIfPresent(String.self, forKey: .allowDocuSignDesktopClient)
        allowDocuSignDesktopClientMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowDocuSignDesktopClientMetadata)
        allowedAddressBookAccess = try container.decodeIfPresent(String.self, forKey: .allowedAddressBookAccess)
        allowedAddressBookAccessMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowedAddressBookAccessMetadata)
        allowedClickwrapsAccess = try container.decodeIfPresent(String.self, forKey: .allowedClickwrapsAccess)
        allowedClickwrapsAccessMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowedClickwrapsAccessMetadata)
        allowedTemplateAccess = try container.decodeIfPresent(String.self, forKey: .allowedTemplateAccess)
        allowedTemplateAccessMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowedTemplateAccessMetadata)
        allowedToBeEnvelopeTransferRecipient = try container.decodeIfPresent(String.self, forKey: .allowedToBeEnvelopeTransferRecipient)
        allowedToBeEnvelopeTransferRecipientMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowedToBeEnvelopeTransferRecipientMetadata)
        allowEnvelopeSending = try container.decodeIfPresent(String.self, forKey: .allowEnvelopeSending)
        allowEnvelopeSendingMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowEnvelopeSendingMetadata)
        ...
        allowPowerFormsAdminToAccessAllPowerFormEnvelopes = try container.decodeIfPresent(String.self, forKey: .allowPowerFormsAdminToAccessAllPowerFormEnvelopes)
        allowPowerFormsAdminToAccessAllPowerFormEnvelopesMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowPowerFormsAdminToAccessAllPowerFormEnvelopesMetadata)
        allowSendersToSetRecipientEmailLanguage = try container.decodeIfPresent(String.self, forKey: .allowSendersToSetRecipientEmailLanguage)
        allowSendersToSetRecipientEmailLanguageMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowSendersToSetRecipientEmailLanguageMetadata)
        allowSignerAttachments = try container.decodeIfPresent(String.self, forKey: .allowSignerAttachments)
        allowSignerAttachmentsMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowSignerAttachmentsMetadata)
        ...
        allowTaggingInSendAndCorrect = try container.decodeIfPresent(String.self, forKey: .allowTaggingInSendAndCorrect)
        allowTaggingInSendAndCorrectMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowTaggingInSendAndCorrectMetadata)
        allowVaulting = try container.decodeIfPresent(String.self, forKey: .allowVaulting)
        allowVaultingMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowVaultingMetadata)
        allowWetSigningOverride = try container.decodeIfPresent(String.self, forKey: .allowWetSigningOverride)
        allowWetSigningOverrideMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .allowWetSigningOverrideMetadata)
        canCreateWorkspaces = try container.decodeIfPresent(String.self, forKey: .canCreateWorkspaces)
        canCreateWorkspacesMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .canCreateWorkspacesMetadata)
        ...
        enableApiRequestLogging = try container.decodeIfPresent(String.self, forKey: .enableApiRequestLogging)
        enableApiRequestLoggingMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .enableApiRequestLoggingMetadata)
        enableRecipientViewingNotifications = try container.decodeIfPresent(String.self, forKey: .enableRecipientViewingNotifications)
        enableRecipientViewingNotificationsMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .enableRecipientViewingNotificationsMetadata)
        enableSequentialSigningInterface = try container.decodeIfPresent(String.self, forKey: .enableSequentialSigningInterface)
        enableSequentialSigningInterfaceMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .enableSequentialSigningInterfaceMetadata)
        enableTransactionPointIntegration = try container.decodeIfPresent(String.self, forKey: .enableTransactionPointIntegration)
        enableTransactionPointIntegrationMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .enableTransactionPointIntegrationMetadata)
        powerFormRole = try container.decodeIfPresent(String.self, forKey: .powerFormRole)
        powerFormRoleMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .powerFormRoleMetadata)
        receiveCompletedSelfSignedDocumentsAsEmailLinks = try container.decodeIfPresent(String.self, forKey: .receiveCompletedSelfSignedDocumentsAsEmailLinks)
        receiveCompletedSelfSignedDocumentsAsEmailLinksMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .receiveCompletedSelfSignedDocumentsAsEmailLinksMetadata)
        ...
        useNewDocuSignExperienceInterface = try container.decodeIfPresent(String.self, forKey: .useNewDocuSignExperienceInterface)
        useNewDocuSignExperienceInterfaceMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .useNewDocuSignExperienceInterfaceMetadata)
        useNewSendingInterface = try container.decodeIfPresent(String.self, forKey: .useNewSendingInterface)
        useNewSendingInterfaceMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .useNewSendingInterfaceMetadata)
...
extension AccountRoleSettings: Hashable {
