...
public final class PaymentGatewayAccount: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowCustomMetadata = try container.decodeIfPresent(Bool.self, forKey: .allowCustomMetadata)
        config = try container.decodeIfPresent(PaymentGatewayAccountSetting.self, forKey: .config)
        displayName = try container.decodeIfPresent(String.self, forKey: .displayName)
        isEnabled = try container.decodeIfPresent(String.self, forKey: .isEnabled)
        isLegacy = try container.decodeIfPresent(String.self, forKey: .isLegacy)
        ...
        paymentGatewayAccountId = try container.decodeIfPresent(String.self, forKey: .paymentGatewayAccountId)
        paymentGatewayDisplayName = try container.decodeIfPresent(String.self, forKey: .paymentGatewayDisplayName)
        payPalLegacySettings = try container.decodeIfPresent(PayPalLegacySettings.self, forKey: .payPalLegacySettings)
        supportedCurrencies = try container.decodeIfPresent([String].self, forKey: .supportedCurrencies)
        supportedPaymentMethods = try container.decodeIfPresent([String].self, forKey: .supportedPaymentMethods)
        supportedPaymentMethodsWithOptions = try container.decodeIfPresent([PaymentMethodWithOptions].self, forKey: .supportedPaymentMethodsWithOptions)
        zeroDecimalCurrencies = try container.decodeIfPresent([String].self, forKey: .zeroDecimalCurrencies)
    }
}

extension PaymentGatewayAccount: Hashable {
    public static func == (lhs: PaymentGatewayAccount, rhs: PaymentGatewayAccount) -> Bool {
