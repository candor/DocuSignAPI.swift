...
public final class UserSharedItem: Content {
...
extension UserSharedItem: Hashable {
    public static func == (lhs: UserSharedItem, rhs: UserSharedItem) -> Bool {
