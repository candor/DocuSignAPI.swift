...
public final class Witness: Content {
    ...
    public init(accessCode: String? = nil, accessCodeMetadata: PropertyMetadata? = nil, addAccessCodeToEmail: String? = nil, additionalNotifications: [RecipientAdditionalNotification]? = nil, agentCanEditEmail: String? = nil, agentCanEditName: String? = nil, allowSystemOverrideForLockedRecipient: String? = nil, autoNavigation: String? = nil, bulkRecipientsUri: String? = nil, canSignOffline: String? = nil, clientUserId: String? = nil, completedCount: String? = nil, creationReason: String? = nil, customFields: [String]? = nil, declinedDateTime: String? = nil, declinedReason: String? = nil, defaultRecipient: String? = nil, deliveredDateTime: String? = nil, deliveryMethod: String? = nil, deliveryMethodMetadata: PropertyMetadata? = nil, designatorId: String? = nil, designatorIdGuid: String? = nil, documentVisibility: [DocumentVisibility]? = nil, email: String? = nil, emailMetadata: PropertyMetadata? = nil, emailNotification: RecipientEmailNotification? = nil, embeddedRecipientStartURL: String? = nil, errorDetails: ErrorDetails? = nil, excludedDocuments: [String]? = nil, faxNumber: String? = nil, faxNumberMetadata: PropertyMetadata? = nil, firstName: String? = nil, firstNameMetadata: PropertyMetadata? = nil, fullName: String? = nil, fullNameMetadata: PropertyMetadata? = nil, idCheckConfigurationName: String? = nil, idCheckConfigurationNameMetadata: PropertyMetadata? = nil, idCheckInformationInput: IdCheckInformationInput? = nil, identityVerification: RecipientIdentityVerification? = nil, inheritEmailNotificationConfiguration: String? = nil, isBulkRecipient: String? = nil, isBulkRecipientMetadata: PropertyMetadata? = nil, lastName: String? = nil, lastNameMetadata: PropertyMetadata? = nil, lockedRecipientPhoneAuthEditable: String? = nil, lockedRecipientSmsEditable: String? = nil, name: String? = nil, nameMetadata: PropertyMetadata? = nil, notaryId: String? = nil, note: String? = nil, noteMetadata: PropertyMetadata? = nil, offlineAttributes: OfflineAttributes? = nil, phoneAuthentication: RecipientPhoneAuthentication? = nil, proofFile: RecipientProofFile? = nil, recipientAttachments: [RecipientAttachment]? = nil, recipientAuthenticationStatus: AuthenticationStatus? = nil, recipientFeatureMetadata: [FeatureAvailableMetadata]? = nil, recipientId: String? = nil, recipientIdGuid: String? = nil, recipientSignatureProviders: [RecipientSignatureProvider]? = nil, recipientSuppliesTabs: String? = nil, recipientType: String? = nil, recipientTypeMetadata: PropertyMetadata? = nil, requireIdLookup: String? = nil, requireIdLookupMetadata: PropertyMetadata? = nil, requireSignerCertificate: String? = nil, requireSignOnPaper: String? = nil, requireUploadSignature: String? = nil, roleName: String? = nil, routingOrder: String? = nil, routingOrderMetadata: PropertyMetadata? = nil, sentDateTime: String? = nil, signatureInfo: RecipientSignatureInformation? = nil, signedDateTime: String? = nil, signInEachLocation: String? = nil, signInEachLocationMetadata: PropertyMetadata? = nil, signingGroupId: String? = nil, signingGroupIdMetadata: PropertyMetadata? = nil, signingGroupName: String? = nil, signingGroupUsers: [UserInfo]? = nil, smsAuthentication: RecipientSMSAuthentication? = nil, socialAuthentications: [SocialAuthentication]? = nil, status: String? = nil, statusCode: String? = nil, suppressEmails: String? = nil, tabs: EnvelopeRecipientTabs? = nil, templateLocked: String? = nil, templateRequired: String? = nil, totalTabCount: String? = nil, userId: String? = nil, witnessFor: String? = nil, witnessForGuid: String? = nil) {
        ...
        self.userId = userId
        self.witnessFor = witnessFor
        self.witnessForGuid = witnessForGuid
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(witnessFor, forKey: .witnessFor)
        try container.encodeIfPresent(witnessForGuid, forKey: .witnessForGuid)
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        witnessFor = try container.decodeIfPresent(String.self, forKey: .witnessFor)
        witnessForGuid = try container.decodeIfPresent(String.self, forKey: .witnessForGuid)
    }
}

extension Witness: Hashable {
    public static func == (lhs: Witness, rhs: Witness) -> Bool {
        lhs.accessCode == rhs.accessCode &&
            ...
            lhs.witnessFor == rhs.witnessFor &&
            lhs.witnessForGuid == rhs.witnessForGuid
    }
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(witnessFor?.hashValue)
        hasher.combine(witnessForGuid?.hashValue)
    }
}
