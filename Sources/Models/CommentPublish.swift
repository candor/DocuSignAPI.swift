...
/**  */
public final class CommentPublish: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        threadAnchorKeys = try container.decodeIfPresent([String: String].self, forKey: .threadAnchorKeys)
        threadId = try container.decodeIfPresent(String.self, forKey: .threadId)
        visibleTo = try container.decodeIfPresent([String].self, forKey: .visibleTo)
    }
}

extension CommentPublish: Hashable {
