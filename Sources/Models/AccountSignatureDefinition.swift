//
// AccountSignatureDefinition.swift
//
...
/**  */
public final class AccountSignatureDefinition: Content {
    ...
    /**  */
    public var signatureGroups: [SignatureGroupDef]?
    ...
    /**  */
    public var signatureUsers: [SignatureUserDef]?
    ...
    public init(dateStampProperties: DateStampProperties? = nil, disallowUserResizeStamp: String? = nil, externalID: String? = nil, imageType: String? = nil, isDefault: String? = nil, nrdsId: String? = nil, nrdsLastName: String? = nil, phoneticName: String? = nil, signatureFont: String? = nil, signatureGroups: [SignatureGroupDef]? = nil, signatureId: String? = nil, signatureInitials: String? = nil, signatureName: String? = nil, signatureUsers: [SignatureUserDef]? = nil, stampFormat: String? = nil, stampSizeMM: String? = nil) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        signatureGroups = try container.decodeIfPresent([SignatureGroupDef].self, forKey: .signatureGroups)
        ...
        signatureUsers = try container.decodeIfPresent([SignatureUserDef].self, forKey: .signatureUsers)
...
extension AccountSignatureDefinition: Hashable {
    public static func == (lhs: AccountSignatureDefinition, rhs: AccountSignatureDefinition) -> Bool {
