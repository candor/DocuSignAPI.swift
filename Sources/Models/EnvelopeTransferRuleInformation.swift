//
// EnvelopeTransferRuleInformation.swift
//
...
/**  */
public final class EnvelopeTransferRuleInformation: Content {
    /** The last index position in the result set.  */
    public var endPosition: String?
    /** Contains information about a specific envelope transfer rule. */
    public var envelopeTransferRules: [EnvelopeTransferRule]?
    ...
    public init(endPosition: String? = nil, envelopeTransferRules: [EnvelopeTransferRule]? = nil, nextUri: String? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil) {
        self.endPosition = endPosition
        self.envelopeTransferRules = envelopeTransferRules
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(envelopeTransferRules, forKey: .envelopeTransferRules)
    ...
    public init(from decoder: Decoder) throws {
        ...
        envelopeTransferRules = try container.decodeIfPresent([EnvelopeTransferRule].self, forKey: .envelopeTransferRules)
...
extension EnvelopeTransferRuleInformation: Hashable {
    public static func == (lhs: EnvelopeTransferRuleInformation, rhs: EnvelopeTransferRuleInformation) -> Bool {
        lhs.endPosition == rhs.endPosition &&
            lhs.envelopeTransferRules == rhs.envelopeTransferRules &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(envelopeTransferRules?.hashValue)
