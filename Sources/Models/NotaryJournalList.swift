...
/**  */
public final class NotaryJournalList: Content {
    /** The last index position in the result set.  */
    public var endPosition: String?
    /** The URI for the next chunk of records based on the search request. It is `null` if this is the last set of results for the search.  */
    public var nextUri: String?
    /**  */
    public var notaryJournals: [NotaryJournal]?
    ...
    public init(endPosition: String? = nil, nextUri: String? = nil, notaryJournals: [NotaryJournal]? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil) {
        self.endPosition = endPosition
        self.nextUri = nextUri
        self.notaryJournals = notaryJournals
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(notaryJournals, forKey: .notaryJournals)
    ...
    public init(from decoder: Decoder) throws {
        ...
        notaryJournals = try container.decodeIfPresent([NotaryJournal].self, forKey: .notaryJournals)
...
extension NotaryJournalList: Hashable {
    public static func == (lhs: NotaryJournalList, rhs: NotaryJournalList) -> Bool {
        lhs.endPosition == rhs.endPosition &&
            lhs.nextUri == rhs.nextUri &&
            lhs.notaryJournals == rhs.notaryJournals &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(notaryJournals?.hashValue)
