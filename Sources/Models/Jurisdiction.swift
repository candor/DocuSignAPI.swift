...
public final class Jurisdiction: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowSystemCreatedSeal = try container.decodeIfPresent(String.self, forKey: .allowSystemCreatedSeal)
        allowUserUploadedSeal = try container.decodeIfPresent(String.self, forKey: .allowUserUploadedSeal)
        commissionIdInSeal = try container.decodeIfPresent(String.self, forKey: .commissionIdInSeal)
        county = try container.decodeIfPresent(String.self, forKey: .county)
        countyInSeal = try container.decodeIfPresent(String.self, forKey: .countyInSeal)
        ...
        notaryPublicInSeal = try container.decodeIfPresent(String.self, forKey: .notaryPublicInSeal)
        stateNameInSeal = try container.decodeIfPresent(String.self, forKey: .stateNameInSeal)
    }
}

extension Jurisdiction: Hashable {
