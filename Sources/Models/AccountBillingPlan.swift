...
public final class AccountBillingPlan: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        canCancelRenewal = try container.decodeIfPresent(String.self, forKey: .canCancelRenewal)
...
extension AccountBillingPlan: Hashable {
