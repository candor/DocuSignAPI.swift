...
public final class FolderItemV2: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        folderUri = try container.decodeIfPresent(String.self, forKey: .folderUri)
        ...
        senderCompany = try container.decodeIfPresent(String.self, forKey: .senderCompany)
        ...
        templateUri = try container.decodeIfPresent(String.self, forKey: .templateUri)
    }
}

extension FolderItemV2: Hashable {
