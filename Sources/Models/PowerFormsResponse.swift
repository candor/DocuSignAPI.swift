...
public final class PowerFormsResponse: Content {
    ...
    public init(endPosition: Int? = nil, nextUri: String? = nil, powerForms: [PowerForm]? = nil, previousUri: String? = nil, resultSetSize: Int? = nil, startPosition: Int? = nil, totalSetSize: Int? = nil) {
...
extension PowerFormsResponse: Hashable {
    public static func == (lhs: PowerFormsResponse, rhs: PowerFormsResponse) -> Bool {
