...
public final class PaymentDetails: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowedPaymentMethods = try container.decodeIfPresent([String].self, forKey: .allowedPaymentMethods)
        chargeId = try container.decodeIfPresent(String.self, forKey: .chargeId)
        currencyCode = try container.decodeIfPresent(String.self, forKey: .currencyCode)
        currencyCodeMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .currencyCodeMetadata)
        customerId = try container.decodeIfPresent(String.self, forKey: .customerId)
        customMetadata = try container.decodeIfPresent(String.self, forKey: .customMetadata)
        customMetadataRequired = try container.decodeIfPresent(Bool.self, forKey: .customMetadataRequired)
        gatewayAccountId = try container.decodeIfPresent(String.self, forKey: .gatewayAccountId)
        gatewayAccountIdMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .gatewayAccountIdMetadata)
        gatewayDisplayName = try container.decodeIfPresent(String.self, forKey: .gatewayDisplayName)
        gatewayName = try container.decodeIfPresent(String.self, forKey: .gatewayName)
        lineItems = try container.decodeIfPresent([PaymentLineItem].self, forKey: .lineItems)
        paymentOption = try container.decodeIfPresent(String.self, forKey: .paymentOption)
        paymentSourceId = try container.decodeIfPresent(String.self, forKey: .paymentSourceId)
        status = try container.decodeIfPresent(String.self, forKey: .status)
        total = try container.decodeIfPresent(Money.self, forKey: .total)
    }
}

extension PaymentDetails: Hashable {
