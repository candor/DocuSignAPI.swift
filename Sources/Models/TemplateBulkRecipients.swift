...
public final class TemplateBulkRecipients: Content {
...
extension TemplateBulkRecipients: Hashable {
    public static func == (lhs: TemplateBulkRecipients, rhs: TemplateBulkRecipients) -> Bool {
