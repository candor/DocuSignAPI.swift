...
public final class PolyLineOverlay: Content {
    /**  */
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(graphicsContext, forKey: .graphicsContext)
        ...
        try container.encodeIfPresent(polyLines, forKey: .polyLines)
    ...
    public init(from decoder: Decoder) throws {
        ...
        graphicsContext = try container.decodeIfPresent(GraphicsContext.self, forKey: .graphicsContext)
...
extension PolyLineOverlay: Hashable {
    public static func == (lhs: PolyLineOverlay, rhs: PolyLineOverlay) -> Bool {
        lhs.anchorAllowWhiteSpaceInCharacters == rhs.anchorAllowWhiteSpaceInCharacters &&
            ...
            lhs.graphicsContext == rhs.graphicsContext &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(graphicsContext?.hashValue)
        ...
        hasher.combine(polyLines?.hashValue)
