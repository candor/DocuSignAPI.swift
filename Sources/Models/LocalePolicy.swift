...
/**  */
public final class LocalePolicy: Content {
    /**  */
    ...
    public init(from decoder: Decoder) throws {
        ...
        addressFormatMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .addressFormatMetadata)
        allowRegion = try container.decodeIfPresent(String.self, forKey: .allowRegion)
        calendarType = try container.decodeIfPresent(String.self, forKey: .calendarType)
        calendarTypeMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .calendarTypeMetadata)
        cultureName = try container.decodeIfPresent(String.self, forKey: .cultureName)
        cultureNameMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .cultureNameMetadata)
        currencyCode = try container.decodeIfPresent(String.self, forKey: .currencyCode)
        currencyCodeMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .currencyCodeMetadata)
        currencyNegativeFormat = try container.decodeIfPresent(String.self, forKey: .currencyNegativeFormat)
        currencyNegativeFormatMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .currencyNegativeFormatMetadata)
        currencyPositiveFormat = try container.decodeIfPresent(String.self, forKey: .currencyPositiveFormat)
        currencyPositiveFormatMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .currencyPositiveFormatMetadata)
        customDateFormat = try container.decodeIfPresent(String.self, forKey: .customDateFormat)
        customSignDateFormat = try container.decodeIfPresent(String.self, forKey: .customSignDateFormat)
        customSignTimeFormat = try container.decodeIfPresent(String.self, forKey: .customSignTimeFormat)
        ...
        dateFormatMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .dateFormatMetadata)
        effectiveAddressFormat = try container.decodeIfPresent(String.self, forKey: .effectiveAddressFormat)
        effectiveCalendarType = try container.decodeIfPresent(String.self, forKey: .effectiveCalendarType)
        effectiveCurrencyCode = try container.decodeIfPresent(String.self, forKey: .effectiveCurrencyCode)
        effectiveCurrencyNegativeFormat = try container.decodeIfPresent(String.self, forKey: .effectiveCurrencyNegativeFormat)
        effectiveCurrencyPositiveFormat = try container.decodeIfPresent(String.self, forKey: .effectiveCurrencyPositiveFormat)
        effectiveCustomDateFormat = try container.decodeIfPresent(String.self, forKey: .effectiveCustomDateFormat)
        effectiveCustomTimeFormat = try container.decodeIfPresent(String.self, forKey: .effectiveCustomTimeFormat)
        effectiveDateFormat = try container.decodeIfPresent(String.self, forKey: .effectiveDateFormat)
        effectiveInitialFormat = try container.decodeIfPresent(String.self, forKey: .effectiveInitialFormat)
        effectiveNameFormat = try container.decodeIfPresent(String.self, forKey: .effectiveNameFormat)
        effectiveTimeFormat = try container.decodeIfPresent(String.self, forKey: .effectiveTimeFormat)
        ...
        initialFormatMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .initialFormatMetadata)
        nameFormat = try container.decodeIfPresent(String.self, forKey: .nameFormat)
        nameFormatMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .nameFormatMetadata)
        ...
        timeFormatMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .timeFormatMetadata)
        timeZone = try container.decodeIfPresent(String.self, forKey: .timeZone)
        timeZoneMetadata = try container.decodeIfPresent(SettingsMetadata.self, forKey: .timeZoneMetadata)
    }
}

extension LocalePolicy: Hashable {
