...
/**  */
public final class CommissionCounty: Content {
    /**  */
...
extension CommissionCounty: Hashable {
    public static func == (lhs: CommissionCounty, rhs: CommissionCounty) -> Bool {
