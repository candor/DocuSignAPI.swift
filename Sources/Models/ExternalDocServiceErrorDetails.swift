...
/**  */
public final class ExternalDocServiceErrorDetails: Content {
    /** Reserved: TBD */
    ...
    public init(from decoder: Decoder) throws {
        ...
        authenticationUrl = try container.decodeIfPresent(String.self, forKey: .authenticationUrl)
        errorCode = try container.decodeIfPresent(String.self, forKey: .errorCode)
        message = try container.decodeIfPresent(String.self, forKey: .message)
    }
}

extension ExternalDocServiceErrorDetails: Hashable {
