...
/**  */
public final class BulkEnvelopeStatus: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        bulkEnvelopes = try container.decodeIfPresent([BulkEnvelope].self, forKey: .bulkEnvelopes)
        bulkEnvelopesBatchUri = try container.decodeIfPresent(String.self, forKey: .bulkEnvelopesBatchUri)
...
extension BulkEnvelopeStatus: Hashable {
