...
/**  */
public final class RecipientEvent: Content {
    /** reserved */
    ...
    public init(from decoder: Decoder) throws {
        ...
        recipientEventStatusCode = try container.decodeIfPresent(String.self, forKey: .recipientEventStatusCode)
    }
}

extension RecipientEvent: Hashable {
