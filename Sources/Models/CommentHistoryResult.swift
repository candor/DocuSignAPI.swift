...
/**  */
public final class CommentHistoryResult: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        endTimetoken = try container.decodeIfPresent(String.self, forKey: .endTimetoken)
        startTimetoken = try container.decodeIfPresent(String.self, forKey: .startTimetoken)
    }
}

extension CommentHistoryResult: Hashable {
