...
/**  */
public final class ReportInProductRunResponse: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        exceededMaxResults = try container.decodeIfPresent(String.self, forKey: .exceededMaxResults)
        lastWarehouseRefreshDateTime = try container.decodeIfPresent(String.self, forKey: .lastWarehouseRefreshDateTime)
        resultSetSize = try container.decodeIfPresent(String.self, forKey: .resultSetSize)
        rows = try container.decodeIfPresent([ReportInProductRunResponseRow].self, forKey: .rows)
...
extension ReportInProductRunResponse: Hashable {
