...
public final class EnvelopeEmailSettings: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        bccEmailAddresses = try container.decodeIfPresent([BccEmailAddress].self, forKey: .bccEmailAddresses)
        replyEmailAddressOverride = try container.decodeIfPresent(String.self, forKey: .replyEmailAddressOverride)
        replyEmailNameOverride = try container.decodeIfPresent(String.self, forKey: .replyEmailNameOverride)
    }
}

extension EnvelopeEmailSettings: Hashable {
    public static func == (lhs: EnvelopeEmailSettings, rhs: EnvelopeEmailSettings) -> Bool {
