...
/**  */
public final class EnvelopeUpdateSummary: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        listCustomFieldUpdateResults = try container.decodeIfPresent([ListCustomField].self, forKey: .listCustomFieldUpdateResults)
        ...
        tabUpdateResults = try container.decodeIfPresent(EnvelopeRecipientTabs.self, forKey: .tabUpdateResults)
        textCustomFieldUpdateResults = try container.decodeIfPresent([TextCustomField].self, forKey: .textCustomFieldUpdateResults)
    }
}

extension EnvelopeUpdateSummary: Hashable {
    public static func == (lhs: EnvelopeUpdateSummary, rhs: EnvelopeUpdateSummary) -> Bool {
