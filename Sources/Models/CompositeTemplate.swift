...
public final class CompositeTemplate: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        compositeTemplateId = try container.decodeIfPresent(String.self, forKey: .compositeTemplateId)
        document = try container.decodeIfPresent(Document.self, forKey: .document)
        inlineTemplates = try container.decodeIfPresent([InlineTemplate].self, forKey: .inlineTemplates)
        pdfMetaDataTemplateSequence = try container.decodeIfPresent(String.self, forKey: .pdfMetaDataTemplateSequence)
        serverTemplates = try container.decodeIfPresent([ServerTemplate].self, forKey: .serverTemplates)
    }
}

extension CompositeTemplate: Hashable {
