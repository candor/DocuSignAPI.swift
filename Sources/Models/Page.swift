...
public final class Page: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        dpi = try container.decodeIfPresent(String.self, forKey: .dpi)
        errorDetails = try container.decodeIfPresent(ErrorDetails.self, forKey: .errorDetails)
        height = try container.decodeIfPresent(String.self, forKey: .height)
        imageBytes = try container.decodeIfPresent(String.self, forKey: .imageBytes)
