...
public final class EnvelopeLocks: Content {
    public var errorDetails: ErrorDetails?
    /** Sets the time, in seconds, until the lock expires when there is no activity on the envelope.  The default value is 300 seconds. The maximum value is 1,800 seconds.  The lock duration can be extended.  */
...
extension EnvelopeLocks: Hashable {
    public static func == (lhs: EnvelopeLocks, rhs: EnvelopeLocks) -> Bool {
