...
/** Groups&#39; users */
public final class GroupUsers: Content {
    ...
    public init(endPosition: String? = nil, nextUri: String? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil, users: [UserInfo]? = nil) {
...
extension GroupUsers: Hashable {
    public static func == (lhs: GroupUsers, rhs: GroupUsers) -> Bool {
