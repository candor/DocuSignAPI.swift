...
/**  */
public final class AccountSignature: Content {
...
extension AccountSignature: Hashable {
    public static func == (lhs: AccountSignature, rhs: AccountSignature) -> Bool {
