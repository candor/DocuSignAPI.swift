...
public final class SignerAttachment: Content {
    /**  */
...
extension SignerAttachment: Hashable {
    public static func == (lhs: SignerAttachment, rhs: SignerAttachment) -> Bool {
