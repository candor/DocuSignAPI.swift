...
/**  */
public final class BulkEnvelope: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        bulkRecipientRow = try container.decodeIfPresent(String.self, forKey: .bulkRecipientRow)
        bulkStatus = try container.decodeIfPresent(String.self, forKey: .bulkStatus)
        ...
        submittedDateTime = try container.decodeIfPresent(String.self, forKey: .submittedDateTime)
        transactionId = try container.decodeIfPresent(String.self, forKey: .transactionId)
    }
}

extension BulkEnvelope: Hashable {
