...
public final class BulkSendTestResponse: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        canBeSent = try container.decodeIfPresent(Bool.self, forKey: .canBeSent)
        validationErrorDetails = try container.decodeIfPresent([String].self, forKey: .validationErrorDetails)
        validationErrors = try container.decodeIfPresent([String].self, forKey: .validationErrors)
    }
}

extension BulkSendTestResponse: Hashable {
