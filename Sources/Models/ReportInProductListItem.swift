...
/**  */
public final class ReportInProductListItem: Content {
    /**  */
    ...
    public init(from decoder: Decoder) throws {
        ...
        getUri = try container.decodeIfPresent(String.self, forKey: .getUri)
        ...
        scheduleCreateDate = try container.decodeIfPresent(String.self, forKey: .scheduleCreateDate)
        scheduleEndDate = try container.decodeIfPresent(String.self, forKey: .scheduleEndDate)
        scheduleId = try container.decodeIfPresent(String.self, forKey: .scheduleId)
        scheduleRenewDurationDays = try container.decodeIfPresent(String.self, forKey: .scheduleRenewDurationDays)
    }
}

extension ReportInProductListItem: Hashable {
