...
public final class BillingCharge: Content {
    /** Reserved: TBD */
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowedQuantity = try container.decodeIfPresent(String.self, forKey: .allowedQuantity)
        ...
        chargeType = try container.decodeIfPresent(String.self, forKey: .chargeType)
        chargeUnitOfMeasure = try container.decodeIfPresent(String.self, forKey: .chargeUnitOfMeasure)
        discounts = try container.decodeIfPresent([BillingDiscount].self, forKey: .discounts)
        firstEffectiveDate = try container.decodeIfPresent(String.self, forKey: .firstEffectiveDate)
        includedQuantity = try container.decodeIfPresent(String.self, forKey: .includedQuantity)
        incrementalQuantity = try container.decodeIfPresent(String.self, forKey: .incrementalQuantity)
        lastEffectiveDate = try container.decodeIfPresent(String.self, forKey: .lastEffectiveDate)
        prices = try container.decodeIfPresent([BillingPrice].self, forKey: .prices)
        unitPrice = try container.decodeIfPresent(String.self, forKey: .unitPrice)
        usedQuantity = try container.decodeIfPresent(String.self, forKey: .usedQuantity)
    }
}

extension BillingCharge: Hashable {
