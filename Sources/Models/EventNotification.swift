...
public final class EventNotification: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        envelopeEvents = try container.decodeIfPresent([EnvelopeEvent].self, forKey: .envelopeEvents)
        ...
        includeCertificateWithSoap = try container.decodeIfPresent(String.self, forKey: .includeCertificateWithSoap)
        ...
        includeTimeZone = try container.decodeIfPresent(String.self, forKey: .includeTimeZone)
        loggingEnabled = try container.decodeIfPresent(String.self, forKey: .loggingEnabled)
        recipientEvents = try container.decodeIfPresent([RecipientEvent].self, forKey: .recipientEvents)
        requireAcknowledgment = try container.decodeIfPresent(String.self, forKey: .requireAcknowledgment)
        signMessageWithX509Cert = try container.decodeIfPresent(String.self, forKey: .signMessageWithX509Cert)
...
extension EventNotification: Hashable {
