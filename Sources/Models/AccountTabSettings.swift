...
public final class AccountTabSettings: Content {
...
extension AccountTabSettings: Hashable {
    public static func == (lhs: AccountTabSettings, rhs: AccountTabSettings) -> Bool {
