...
public final class BillingPlan: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        appStoreProducts = try container.decodeIfPresent([AppStoreProduct].self, forKey: .appStoreProducts)
        currencyPlanPrices = try container.decodeIfPresent([CurrencyPlanPrice].self, forKey: .currencyPlanPrices)
        ...
        otherDiscountPercent = try container.decodeIfPresent(String.self, forKey: .otherDiscountPercent)
        ...
        seatDiscounts = try container.decodeIfPresent([SeatDiscount].self, forKey: .seatDiscounts)
...
extension BillingPlan: Hashable {
