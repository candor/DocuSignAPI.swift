...
/**  */
public final class LoginInformation: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        loginAccounts = try container.decodeIfPresent([LoginAccount].self, forKey: .loginAccounts)
    }
}

extension LoginInformation: Hashable {
