...
/**  */
public final class EnvelopeTemplate: Content {
...
extension EnvelopeTemplate: Hashable {
    public static func == (lhs: EnvelopeTemplate, rhs: EnvelopeTemplate) -> Bool {
