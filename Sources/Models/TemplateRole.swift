...
/**  */
public final class TemplateRole: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        inPersonSignerName = try container.decodeIfPresent(String.self, forKey: .inPersonSignerName)
...
extension TemplateRole: Hashable {
