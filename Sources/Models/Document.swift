...
/** A document object. */
public final class Document: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        applyAnchorTabs = try container.decodeIfPresent(String.self, forKey: .applyAnchorTabs)
        display = try container.decodeIfPresent(String.self, forKey: .display)
        documentBase64 = try container.decodeIfPresent(String.self, forKey: .documentBase64)
        documentFields = try container.decodeIfPresent([NameValue].self, forKey: .documentFields)
        documentId = try container.decodeIfPresent(String.self, forKey: .documentId)
        encryptedWithKeyManager = try container.decodeIfPresent(String.self, forKey: .encryptedWithKeyManager)
        fileExtension = try container.decodeIfPresent(String.self, forKey: .fileExtension)
        fileFormatHint = try container.decodeIfPresent(String.self, forKey: .fileFormatHint)
        ...
        matchBoxes = try container.decodeIfPresent([MatchBox].self, forKey: .matchBoxes)
        name = try container.decodeIfPresent(String.self, forKey: .name)
        order = try container.decodeIfPresent(String.self, forKey: .order)
        pages = try container.decodeIfPresent(String.self, forKey: .pages)
        password = try container.decodeIfPresent(String.self, forKey: .password)
        pdfFormFieldOption = try container.decodeIfPresent(String.self, forKey: .pdfFormFieldOption)
        ...
        signerMustAcknowledgeUseAccountDefault = try container.decodeIfPresent(Bool.self, forKey: .signerMustAcknowledgeUseAccountDefault)
        ...
        transformPdfFields = try container.decodeIfPresent(String.self, forKey: .transformPdfFields)
