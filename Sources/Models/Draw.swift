...
/**  */
public final class Draw: Content {
    /**  */
    public var allowSignerUpload: String?
    /**  */
    ...
    /**  */
    public var useBackgroundAsCanvas: String?
    ...
    public init(allowSignerUpload: String? = nil, anchorAllowWhiteSpaceInCharacters: String? = nil, anchorAllowWhiteSpaceInCharactersMetadata: PropertyMetadata? = nil, anchorCaseSensitive: String? = nil, anchorCaseSensitiveMetadata: PropertyMetadata? = nil, anchorHorizontalAlignment: String? = nil, anchorHorizontalAlignmentMetadata: PropertyMetadata? = nil, anchorIgnoreIfNotPresent: String? = nil, anchorIgnoreIfNotPresentMetadata: PropertyMetadata? = nil, anchorMatchWholeWord: String? = nil, anchorMatchWholeWordMetadata: PropertyMetadata? = nil, anchorString: String? = nil, anchorStringMetadata: PropertyMetadata? = nil, anchorTabProcessorVersion: String? = nil, anchorTabProcessorVersionMetadata: PropertyMetadata? = nil, anchorUnits: String? = nil, anchorUnitsMetadata: PropertyMetadata? = nil, anchorXOffset: String? = nil, anchorXOffsetMetadata: PropertyMetadata? = nil, anchorYOffset: String? = nil, anchorYOffsetMetadata: PropertyMetadata? = nil, conditionalParentLabel: String? = nil, conditionalParentLabelMetadata: PropertyMetadata? = nil, conditionalParentValue: String? = nil, conditionalParentValueMetadata: PropertyMetadata? = nil, customTabId: String? = nil, customTabIdMetadata: PropertyMetadata? = nil, documentId: String? = nil, documentIdMetadata: PropertyMetadata? = nil, errorDetails: ErrorDetails? = nil, formOrder: String? = nil, formOrderMetadata: PropertyMetadata? = nil, formPageLabel: String? = nil, formPageLabelMetadata: PropertyMetadata? = nil, formPageNumber: String? = nil, formPageNumberMetadata: PropertyMetadata? = nil, height: String? = nil, heightMetadata: PropertyMetadata? = nil, locked: String? = nil, lockedMetadata: PropertyMetadata? = nil, mergeField: MergeField? = nil, mergeFieldXml: String? = nil, pageNumber: String? = nil, pageNumberMetadata: PropertyMetadata? = nil, recipientId: String? = nil, recipientIdGuid: String? = nil, recipientIdGuidMetadata: PropertyMetadata? = nil, recipientIdMetadata: PropertyMetadata? = nil, required: String? = nil, requiredMetadata: PropertyMetadata? = nil, shared: String? = nil, sharedMetadata: PropertyMetadata? = nil, smartContractInformation: SmartContractInformation? = nil, status: String? = nil, statusMetadata: PropertyMetadata? = nil, tabGroupLabels: [String]? = nil, tabGroupLabelsMetadata: PropertyMetadata? = nil, tabId: String? = nil, tabIdMetadata: PropertyMetadata? = nil, tabLabelMetadata: PropertyMetadata? = nil, tabOrder: String? = nil, tabOrderMetadata: PropertyMetadata? = nil, tabType: String? = nil, tabTypeMetadata: PropertyMetadata? = nil, templateLocked: String? = nil, templateLockedMetadata: PropertyMetadata? = nil, templateRequired: String? = nil, templateRequiredMetadata: PropertyMetadata? = nil, tooltip: String? = nil, toolTipMetadata: PropertyMetadata? = nil, useBackgroundAsCanvas: String? = nil, width: String? = nil, widthMetadata: PropertyMetadata? = nil, xPosition: String? = nil, xPositionMetadata: PropertyMetadata? = nil, yPosition: String? = nil, yPositionMetadata: PropertyMetadata? = nil) {
        ...
        self.useBackgroundAsCanvas = useBackgroundAsCanvas
        self.width = width
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(allowSignerUpload, forKey: .allowSignerUpload)
        ...
        try container.encodeIfPresent(useBackgroundAsCanvas, forKey: .useBackgroundAsCanvas)
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowSignerUpload = try container.decodeIfPresent(String.self, forKey: .allowSignerUpload)
        ...
        useBackgroundAsCanvas = try container.decodeIfPresent(String.self, forKey: .useBackgroundAsCanvas)
...
extension Draw: Hashable {
    public static func == (lhs: Draw, rhs: Draw) -> Bool {
        lhs.allowSignerUpload == rhs.allowSignerUpload &&
            ...
            lhs.useBackgroundAsCanvas == rhs.useBackgroundAsCanvas &&
            lhs.width == rhs.width &&
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(allowSignerUpload?.hashValue)
        ...
        hasher.combine(useBackgroundAsCanvas?.hashValue)
