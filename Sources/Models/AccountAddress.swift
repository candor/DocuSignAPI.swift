...
public final class AccountAddress: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        supportedCountries = try container.decodeIfPresent([Country].self, forKey: .supportedCountries)
    }
}

extension AccountAddress: Hashable {
