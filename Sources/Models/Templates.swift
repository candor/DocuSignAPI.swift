...
/** Template management */
public final class Templates: Content {
    ...
    public var autoMatch: String?
    /** If **true**, the template has been explicitly included in or excluded from auto-matching. The default is false. This is a read-only property. */
    public var autoMatchSpecifiedByUser: String?
    ...
    /**  */
    public var favoritedByMe: String?
    ...
    public var lastModifiedBy: UserInfo?
    ...
    public var passwordProtected: String?
    ...
    /** When **true**, indicates the template is shared with the **Everyone** group, and is shared with all users on the account.  If **false**, the template is only shared with the **Administrator** group.  */
    ...
    public init(accessControlListBase64: String? = nil, allowComments: String? = nil, allowMarkup: String? = nil, allowReassign: String? = nil, allowViewHistory: String? = nil, anySigner: String? = nil, asynchronous: String? = nil, attachmentsUri: String? = nil, authoritativeCopy: String? = nil, authoritativeCopyDefault: String? = nil, autoMatch: String? = nil, autoMatchSpecifiedByUser: String? = nil, autoNavigation: String? = nil, brandId: String? = nil, brandLock: String? = nil, certificateUri: String? = nil, completedDateTime: String? = nil, copyRecipientData: String? = nil, created: String? = nil, createdDateTime: String? = nil, customFields: AccountCustomFields? = nil, customFieldsUri: String? = nil, declinedDateTime: String? = nil, deletedDateTime: String? = nil, deliveredDateTime: String? = nil, description: String? = nil, disableResponsiveDocument: String? = nil, documents: [Document]? = nil, documentsCombinedUri: String? = nil, documentsUri: String? = nil, emailBlurb: String? = nil, emailSettings: EmailSettings? = nil, emailSubject: String? = nil, enableWetSign: String? = nil, enforceSignerVisibility: String? = nil, envelopeAttachments: [Attachment]? = nil, envelopeDocuments: [EnvelopeDocument]? = nil, envelopeId: String? = nil, envelopeIdStamping: String? = nil, envelopeLocation: String? = nil, envelopeMetadata: EnvelopeMetadata? = nil, envelopeUri: String? = nil, expireAfter: String? = nil, expireDateTime: String? = nil, expireEnabled: String? = nil, externalEnvelopeId: String? = nil, favoritedByMe: String? = nil, folderId: String? = nil, folderIds: [String]? = nil, folderName: String? = nil, folders: [Folder]? = nil, hasComments: String? = nil, hasFormDataChanged: String? = nil, hasWavFile: String? = nil, holder: String? = nil, initialSentDateTime: String? = nil, is21CFRPart11: String? = nil, isDynamicEnvelope: String? = nil, isSignatureProviderEnvelope: String? = nil, lastModified: String? = nil, lastModifiedBy: UserInfo? = nil, lastModifiedDateTime: String? = nil, lastUsed: String? = nil, location: String? = nil, lockInformation: EnvelopeLocks? = nil, messageLock: String? = nil, name: String? = nil, newPassword: String? = nil, notification: Notification? = nil, notificationUri: String? = nil, owner: UserInfo? = nil, pageCount: String? = nil, password: String? = nil, passwordProtected: String? = nil, powerForm: PowerForm? = nil, powerForms: [PowerForm]? = nil, purgeCompletedDate: String? = nil, purgeRequestDate: String? = nil, purgeState: String? = nil, recipients: EnvelopeRecipients? = nil, recipientsLock: String? = nil, recipientsUri: String? = nil, sender: UserInfo? = nil, sentDateTime: String? = nil, shared: String? = nil, signerCanSignOnMobile: String? = nil, signingLocation: String? = nil, status: String? = nil, statusChangedDateTime: String? = nil, statusDateTime: String? = nil, templateId: String? = nil, templatesUri: String? = nil, transactionId: String? = nil, uri: String? = nil, useDisclosure: String? = nil, voidedDateTime: String? = nil, voidedReason: String? = nil, workflow: Workflow? = nil) {
        ...
        self.autoMatchSpecifiedByUser = autoMatchSpecifiedByUser
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(autoMatch, forKey: .autoMatch)
        try container.encodeIfPresent(autoMatchSpecifiedByUser, forKey: .autoMatchSpecifiedByUser)
        ...
        try container.encodeIfPresent(favoritedByMe, forKey: .favoritedByMe)
    ...
    public init(from decoder: Decoder) throws {
        ...
        autoMatch = try container.decodeIfPresent(String.self, forKey: .autoMatch)
        autoMatchSpecifiedByUser = try container.decodeIfPresent(String.self, forKey: .autoMatchSpecifiedByUser)
        ...
        favoritedByMe = try container.decodeIfPresent(String.self, forKey: .favoritedByMe)
        ...
        lastModifiedBy = try container.decodeIfPresent(UserInfo.self, forKey: .lastModifiedBy)
        ...
        pageCount = try container.decodeIfPresent(String.self, forKey: .pageCount)
        password = try container.decodeIfPresent(String.self, forKey: .password)
        passwordProtected = try container.decodeIfPresent(String.self, forKey: .passwordProtected)
...
extension Templates: Hashable {
    public static func == (lhs: Templates, rhs: Templates) -> Bool {
        lhs.accessControlListBase64 == rhs.accessControlListBase64 &&
            ...
            lhs.autoMatch == rhs.autoMatch &&
            lhs.autoMatchSpecifiedByUser == rhs.autoMatchSpecifiedByUser &&
            ...
            lhs.favoritedByMe == rhs.favoritedByMe &&
            ...
            lhs.passwordProtected == rhs.passwordProtected &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(autoMatch?.hashValue)
        hasher.combine(autoMatchSpecifiedByUser?.hashValue)
        ...
        hasher.combine(favoritedByMe?.hashValue)
        hasher.combine(folderId?.hashValue)
        hasher.combine(folderIds?.hashValue)
        hasher.combine(folderName?.hashValue)
        ...
        hasher.combine(passwordProtected?.hashValue)
