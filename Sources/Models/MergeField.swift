...
public final class MergeField: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowSenderToEdit = try container.decodeIfPresent(String.self, forKey: .allowSenderToEdit)
        allowSenderToEditMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .allowSenderToEditMetadata)
        configurationType = try container.decodeIfPresent(String.self, forKey: .configurationType)
        configurationTypeMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .configurationTypeMetadata)
        path = try container.decodeIfPresent(String.self, forKey: .path)
        pathExtended = try container.decodeIfPresent([PathExtendedElement].self, forKey: .pathExtended)
        pathExtendedMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .pathExtendedMetadata)
        pathMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .pathMetadata)
        row = try container.decodeIfPresent(String.self, forKey: .row)
        rowMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .rowMetadata)
        writeBack = try container.decodeIfPresent(String.self, forKey: .writeBack)
        writeBackMetadata = try container.decodeIfPresent(PropertyMetadata.self, forKey: .writeBackMetadata)
    }
}

extension MergeField: Hashable {
