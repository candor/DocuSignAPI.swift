...
public final class EnvelopeRecipientTabs: Content {
...
extension EnvelopeRecipientTabs: Hashable {
    public static func == (lhs: EnvelopeRecipientTabs, rhs: EnvelopeRecipientTabs) -> Bool {
