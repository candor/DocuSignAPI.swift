...
/**  */
public final class ConnectUserObject: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        senderSearchableItems = try container.decodeIfPresent([String].self, forKey: .senderSearchableItems)
    }
}

extension ConnectUserObject: Hashable {
