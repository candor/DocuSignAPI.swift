...
public final class ForgottenPasswordInformation: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        forgottenPasswordAnswer1 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordAnswer1)
        forgottenPasswordAnswer2 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordAnswer2)
        forgottenPasswordAnswer3 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordAnswer3)
        forgottenPasswordAnswer4 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordAnswer4)
        forgottenPasswordQuestion1 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordQuestion1)
        forgottenPasswordQuestion2 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordQuestion2)
        forgottenPasswordQuestion3 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordQuestion3)
        forgottenPasswordQuestion4 = try container.decodeIfPresent(String.self, forKey: .forgottenPasswordQuestion4)
    }
}

extension ForgottenPasswordInformation: Hashable {
