...
/**  */
public final class Watermark: Content {
    /**  */
    ...
    public init(from decoder: Decoder) throws {
        ...
        displayAngle = try container.decodeIfPresent(String.self, forKey: .displayAngle)
        ...
        transparency = try container.decodeIfPresent(String.self, forKey: .transparency)
        watermarkText = try container.decodeIfPresent(String.self, forKey: .watermarkText)
    }
}

extension Watermark: Hashable {
    public static func == (lhs: Watermark, rhs: Watermark) -> Bool {
