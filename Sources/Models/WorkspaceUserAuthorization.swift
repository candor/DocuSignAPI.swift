...
public final class WorkspaceUserAuthorization: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        canDelete = try container.decodeIfPresent(String.self, forKey: .canDelete)
        canMove = try container.decodeIfPresent(String.self, forKey: .canMove)
        canTransact = try container.decodeIfPresent(String.self, forKey: .canTransact)
        canView = try container.decodeIfPresent(String.self, forKey: .canView)
        ...
        modifiedById = try container.decodeIfPresent(String.self, forKey: .modifiedById)
        workspaceUserId = try container.decodeIfPresent(String.self, forKey: .workspaceUserId)
        workspaceUserInformation = try container.decodeIfPresent(WorkspaceUser.self, forKey: .workspaceUserInformation)
    }
}

extension WorkspaceUserAuthorization: Hashable {
