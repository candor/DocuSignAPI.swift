...
/**  */
public final class CommentThread: Content {
    /**  */
...
extension CommentThread: Hashable {
    public static func == (lhs: CommentThread, rhs: CommentThread) -> Bool {
