...
/**  */
public final class ExternalFolder: Content {
...
extension ExternalFolder: Hashable {
    public static func == (lhs: ExternalFolder, rhs: ExternalFolder) -> Bool {
