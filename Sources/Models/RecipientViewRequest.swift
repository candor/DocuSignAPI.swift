...
public final class RecipientViewRequest: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        frameAncestors = try container.decodeIfPresent([String].self, forKey: .frameAncestors)
        messageOrigins = try container.decodeIfPresent([String].self, forKey: .messageOrigins)
...
extension RecipientViewRequest: Hashable {
