...
/**  */
public final class IntegratedUserInfoList: Content {
    /**  */
    public var allUsersSelected: String?
    ...
    public init(allUsersSelected: String? = nil, endPosition: String? = nil, nextUri: String? = nil, previousUri: String? = nil, resultSetSize: String? = nil, startPosition: String? = nil, totalSetSize: String? = nil, users: [UserInfo]? = nil) {
        self.allUsersSelected = allUsersSelected
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(allUsersSelected, forKey: .allUsersSelected)
    ...
    public init(from decoder: Decoder) throws {
        ...
        allUsersSelected = try container.decodeIfPresent(String.self, forKey: .allUsersSelected)
...
extension IntegratedUserInfoList: Hashable {
    public static func == (lhs: IntegratedUserInfoList, rhs: IntegratedUserInfoList) -> Bool {
        lhs.allUsersSelected == rhs.allUsersSelected &&
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(allUsersSelected?.hashValue)
