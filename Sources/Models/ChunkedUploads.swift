...
public final class ChunkedUploads: Content {
...
extension ChunkedUploads: Hashable {
    public static func == (lhs: ChunkedUploads, rhs: ChunkedUploads) -> Bool {
