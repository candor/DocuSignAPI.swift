...
/** Template tabs */
public final class TemplateRecipientTabs: Content {
...
extension TemplateRecipientTabs: Hashable {
    public static func == (lhs: TemplateRecipientTabs, rhs: TemplateRecipientTabs) -> Bool {
