...
/**  */
public final class AccountSignatures: Content {
    ...
    /**  */
    public var signatureGroups: [SignatureGroup]?
    ...
    /**  */
    public var signatureUsers: [SignatureUser]?
    ...
    public init(adoptedDateTime: String? = nil, createdDateTime: String? = nil, customField: String? = nil, dateStampProperties: DateStampProperties? = nil, disallowUserResizeStamp: String? = nil, errorDetails: ErrorDetails? = nil, externalID: String? = nil, imageBase64: String? = nil, imageType: String? = nil, initials150ImageId: String? = nil, initialsImageUri: String? = nil, isDefault: String? = nil, lastModifiedDateTime: String? = nil, nrdsId: String? = nil, nrdsLastName: String? = nil, nrdsStatus: String? = nil, phoneticName: String? = nil, signature150ImageId: String? = nil, signatureFont: String? = nil, signatureGroups: [SignatureGroup]? = nil, signatureId: String? = nil, signatureImageUri: String? = nil, signatureInitials: String? = nil, signatureName: String? = nil, signatureRights: String? = nil, signatureType: String? = nil, signatureUsers: [SignatureUser]? = nil, stampFormat: String? = nil, stampImageUri: String? = nil, stampSizeMM: String? = nil, stampType: String? = nil, status: String? = nil) {
        ...
        self.signatureGroups = signatureGroups
        ...
        self.signatureUsers = signatureUsers
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(signatureGroups, forKey: .signatureGroups)
        ...
        try container.encodeIfPresent(signatureUsers, forKey: .signatureUsers)
    ...
    public init(from decoder: Decoder) throws {
        ...
        signatureGroups = try container.decodeIfPresent([SignatureGroup].self, forKey: .signatureGroups)
        ...
        signatureUsers = try container.decodeIfPresent([SignatureUser].self, forKey: .signatureUsers)
...
extension AccountSignatures: Hashable {
    public static func == (lhs: AccountSignatures, rhs: AccountSignatures) -> Bool {
        lhs.adoptedDateTime == rhs.adoptedDateTime &&
            ...
            lhs.signatureGroups == rhs.signatureGroups &&
            ...
            lhs.signatureUsers == rhs.signatureUsers &&
    ...
    public func hash(into hasher: inout Hasher) {
        ...
        hasher.combine(signatureGroups?.hashValue)
        ...
        hasher.combine(signatureUsers?.hashValue)
