...
public final class BrandLink: Content {
    ...
    public init(from decoder: Decoder) throws {
        ...
        showLink = try container.decodeIfPresent(String.self, forKey: .showLink)
        urlOrMailTo = try container.decodeIfPresent(String.self, forKey: .urlOrMailTo)
    }
}

extension BrandLink: Hashable {
