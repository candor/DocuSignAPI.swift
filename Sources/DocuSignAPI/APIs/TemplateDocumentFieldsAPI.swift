...
open class TemplateDocumentFieldsAPI {
     ...
     */
    open class func documentFieldsDeleteTemplateDocumentFieldsRaw(accountId: String, documentId: String, templateId: String, documentFieldsInformation: DocumentFieldsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func documentFieldsDeleteTemplateDocumentFields(accountId: String, documentId: String, templateId: String, documentFieldsInformation: DocumentFieldsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<DocumentFieldsDeleteTemplateDocumentFields> {
        return documentFieldsDeleteTemplateDocumentFieldsRaw(accountId: accountId, documentId: documentId, templateId: templateId, documentFieldsInformation: documentFieldsInformation, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> DocumentFieldsDeleteTemplateDocumentFields in
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func documentFieldsGetTemplateDocumentFieldsRaw(accountId: String, documentId: String, templateId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates/{templateId}/documents/{documentId}/fields"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func documentFieldsGetTemplateDocumentFields(accountId: String, documentId: String, templateId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<DocumentFieldsGetTemplateDocumentFields> {
        return documentFieldsGetTemplateDocumentFieldsRaw(accountId: accountId, documentId: documentId, templateId: templateId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> DocumentFieldsGetTemplateDocumentFields in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(DocumentFieldsInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: DocumentFieldsInformation.defaultContentType)), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func documentFieldsPostTemplateDocumentFieldsRaw(accountId: String, documentId: String, templateId: String, documentFieldsInformation: DocumentFieldsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates/{templateId}/documents/{documentId}/fields"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func documentFieldsPostTemplateDocumentFields(accountId: String, documentId: String, templateId: String, documentFieldsInformation: DocumentFieldsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<DocumentFieldsPostTemplateDocumentFields> {
        return documentFieldsPostTemplateDocumentFieldsRaw(accountId: accountId, documentId: documentId, templateId: templateId, documentFieldsInformation: documentFieldsInformation, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> DocumentFieldsPostTemplateDocumentFields in
            switch response.status.code {
            case 201:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func documentFieldsPutTemplateDocumentFieldsRaw(accountId: String, documentId: String, templateId: String, documentFieldsInformation: DocumentFieldsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates/{templateId}/documents/{documentId}/fields"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func documentFieldsPutTemplateDocumentFields(accountId: String, documentId: String, templateId: String, documentFieldsInformation: DocumentFieldsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<DocumentFieldsPutTemplateDocumentFields> {
        return documentFieldsPutTemplateDocumentFieldsRaw(accountId: accountId, documentId: documentId, templateId: templateId, documentFieldsInformation: documentFieldsInformation, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> DocumentFieldsPutTemplateDocumentFields in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(DocumentFieldsInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: DocumentFieldsInformation.defaultContentType)), raw: response)
            case 400:
