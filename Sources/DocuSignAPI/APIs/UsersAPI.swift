...
open class UsersAPI {
     ...
     */
    open class func userGetUserRaw(accountId: String, userId: String, additionalInfo: String? = nil, email: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func userGetUser(accountId: String, userId: String, additionalInfo: String? = nil, email: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UserGetUser> {
        return userGetUserRaw(accountId: accountId, userId: userId, additionalInfo: additionalInfo, email: email, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UserGetUser in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(UserInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: UserInformation.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(UserInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: UserInformation.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func userProfileImageDeleteUserProfileImageRaw(accountId: String, userId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func userProfileImageDeleteUserProfileImage(accountId: String, userId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UserProfileImageDeleteUserProfileImage> {
        return userProfileImageDeleteUserProfileImageRaw(accountId: accountId, userId: userId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UserProfileImageDeleteUserProfileImage in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func userProfileImageGetUserProfileImageRaw(accountId: String, userId: String, encoding: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/users/{userId}/profile/image"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func userProfileImageGetUserProfileImage(accountId: String, userId: String, encoding: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UserProfileImageGetUserProfileImage> {
        return userProfileImageGetUserProfileImageRaw(accountId: accountId, userId: userId, encoding: encoding, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UserProfileImageGetUserProfileImage in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func userProfileImagePutUserProfileImageRaw(accountId: String, userId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/users/{userId}/profile/image"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func userProfileImagePutUserProfileImage(accountId: String, userId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UserProfileImagePutUserProfileImage> {
        return userProfileImagePutUserProfileImageRaw(accountId: accountId, userId: userId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UserProfileImagePutUserProfileImage in
            switch response.status.code {
            case 200:
                return .http200(value: (), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func userPutUserRaw(accountId: String, userId: String, userInformation: UserInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/users/{userId}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func userPutUser(accountId: String, userId: String, userInformation: UserInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UserPutUser> {
        return userPutUserRaw(accountId: accountId, userId: userId, userInformation: userInformation, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UserPutUser in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(UserInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: UserInformation.defaultContentType)), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func userSettingsGetUserSettingsRaw(accountId: String, userId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func userSettingsGetUserSettings(accountId: String, userId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UserSettingsGetUserSettings> {
        return userSettingsGetUserSettingsRaw(accountId: accountId, userId: userId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UserSettingsGetUserSettings in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(UserSettingsInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: UserSettingsInformation.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(UserSettingsInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: UserSettingsInformation.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func userSettingsPutUserSettingsRaw(accountId: String, userId: String, userSettingsInformation: UserSettingsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/users/{userId}/settings"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func userSettingsPutUserSettings(accountId: String, userId: String, userSettingsInformation: UserSettingsInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UserSettingsPutUserSettings> {
        return userSettingsPutUserSettingsRaw(accountId: accountId, userId: userId, userSettingsInformation: userSettingsInformation, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UserSettingsPutUserSettings in
            switch response.status.code {
            case 200:
                return .http200(value: (), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func usersDeleteUsersRaw(accountId: String, delete: String? = nil, userInfoList: UserInfoList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func usersDeleteUsers(accountId: String, delete: String? = nil, userInfoList: UserInfoList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UsersDeleteUsers> {
        return usersDeleteUsersRaw(accountId: accountId, delete: delete, userInfoList: userInfoList, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UsersDeleteUsers in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func usersGetUsersRaw(accountId: String, additionalInfo: String? = nil, count: String? = nil, email: String? = nil, emailSubstring: String? = nil, groupId: String? = nil, includeUsersettingsForCsv: String? = nil, loginStatus: String? = nil, notGroupId: String? = nil, startPosition: String? = nil, status: String? = nil, userNameSubstring: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/users"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func usersGetUsers(accountId: String, additionalInfo: String? = nil, count: String? = nil, email: String? = nil, emailSubstring: String? = nil, groupId: String? = nil, includeUsersettingsForCsv: String? = nil, loginStatus: String? = nil, notGroupId: String? = nil, startPosition: String? = nil, status: String? = nil, userNameSubstring: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UsersGetUsers> {
        return usersGetUsersRaw(accountId: accountId, additionalInfo: additionalInfo, count: count, email: email, emailSubstring: emailSubstring, groupId: groupId, includeUsersettingsForCsv: includeUsersettingsForCsv, loginStatus: loginStatus, notGroupId: notGroupId, startPosition: startPosition, status: status, userNameSubstring: userNameSubstring, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UsersGetUsers in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(UserInformationList.self, using: Configuration.contentConfiguration.requireDecoder(for: UserInformationList.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(UserInformationList.self, using: Configuration.contentConfiguration.requireDecoder(for: UserInformationList.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func usersPostUsersRaw(accountId: String, newUsersDefinition: NewUsersDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/users"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func usersPostUsers(accountId: String, newUsersDefinition: NewUsersDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UsersPostUsers> {
        return usersPostUsersRaw(accountId: accountId, newUsersDefinition: newUsersDefinition, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UsersPostUsers in
            switch response.status.code {
            case 201:
                return .http201(value: try response.content.decode(NewUsersSummary.self, using: Configuration.contentConfiguration.requireDecoder(for: NewUsersSummary.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(NewUsersSummary.self, using: Configuration.contentConfiguration.requireDecoder(for: NewUsersSummary.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func usersPutUsersRaw(accountId: String, userInformationList: UserInformationList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/users"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func usersPutUsers(accountId: String, userInformationList: UserInformationList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<UsersPutUsers> {
        return usersPutUsersRaw(accountId: accountId, userInformationList: userInformationList, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> UsersPutUsers in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(UserInformationList.self, using: Configuration.contentConfiguration.requireDecoder(for: UserInformationList.defaultContentType)), raw: response)
            case 400:
