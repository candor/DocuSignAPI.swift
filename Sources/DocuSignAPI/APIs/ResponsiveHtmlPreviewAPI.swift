...
open class ResponsiveHtmlPreviewAPI {
     ...
     */
    open class func responsiveHtmlPostResponsiveHtmlPreviewRaw(accountId: String, envelopeId: String, documentHtmlDefinition: DocumentHtmlDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func responsiveHtmlPostResponsiveHtmlPreview(accountId: String, envelopeId: String, documentHtmlDefinition: DocumentHtmlDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ResponsiveHtmlPostResponsiveHtmlPreview> {
        return responsiveHtmlPostResponsiveHtmlPreviewRaw(accountId: accountId, envelopeId: envelopeId, documentHtmlDefinition: documentHtmlDefinition, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> ResponsiveHtmlPostResponsiveHtmlPreview in
