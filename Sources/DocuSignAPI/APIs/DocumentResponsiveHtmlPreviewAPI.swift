//
// DocumentResponsiveHtmlPreviewAPI.swift
//
...
open class DocumentResponsiveHtmlPreviewAPI {
    /**
     ...
     */
    open class func responsiveHtmlPostDocumentResponsiveHtmlPreviewRaw(accountId: String, documentId: String, envelopeId: String, documentHtmlDefinition: DocumentHtmlDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}/responsive_html_preview"
    ...
    /**
     ...
     - parameter envelopeId: (path) The envelope's GUID.   Example: `93be49ab-xxxx-xxxx-xxxx-f752070d71ec`
     - parameter documentHtmlDefinition: (body)  (optional)
     - returns: `EventLoopFuture` of `ResponsiveHtmlPostDocumentResponsiveHtmlPreview`
     */
    open class func responsiveHtmlPostDocumentResponsiveHtmlPreview(accountId: String, documentId: String, envelopeId: String, documentHtmlDefinition: DocumentHtmlDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ResponsiveHtmlPostDocumentResponsiveHtmlPreview> {
        return responsiveHtmlPostDocumentResponsiveHtmlPreviewRaw(accountId: accountId, documentId: documentId, envelopeId: envelopeId, documentHtmlDefinition: documentHtmlDefinition, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> ResponsiveHtmlPostDocumentResponsiveHtmlPreview in
