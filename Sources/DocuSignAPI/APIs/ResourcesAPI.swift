...
open class ResourcesAPI {
     ...
     */
    open class func serviceInformationGetResourceInformationRaw(headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        let path = "/v2.1"
    ...
    open class func serviceInformationGetResourceInformation(headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ServiceInformationGetResourceInformation> {
        return serviceInformationGetResourceInformationRaw(headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> ServiceInformationGetResourceInformation in
