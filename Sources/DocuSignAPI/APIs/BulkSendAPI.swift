...
open class BulkSendAPI {
    /**

     GET /v2.1/accounts/{accountId}/bulk_send_batch/{bulkSendBatchId}

     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - parameter bulkSendBatchId: (path)
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2BatchGetBulkSendBatchStatusRaw(accountId: String, bulkSendBatchId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_batch/{bulkSendBatchId}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
        let bulkSendBatchIdPreEscape = String(describing: bulkSendBatchId)
        let bulkSendBatchIdPostEscape = bulkSendBatchIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{bulkSendBatchId}", with: bulkSendBatchIdPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - parameter bulkSendBatchId: (path)
     - returns: `EventLoopFuture` of `BulkSendV2BatchGetBulkSendBatchStatus`
     */
    open class func bulkSendV2BatchGetBulkSendBatchStatus(accountId: String, bulkSendBatchId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2BatchGetBulkSendBatchStatus> {
        return bulkSendV2BatchGetBulkSendBatchStatusRaw(accountId: accountId, bulkSendBatchId: bulkSendBatchId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2BatchGetBulkSendBatchStatus in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BulkSendBatchStatus.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendBatchStatus.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BulkSendBatchStatus.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendBatchStatus.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - parameter batchIds: (query)  (optional)
     ...
     - parameter status: (query) The status of the item. (optional)
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2BatchGetBulkSendBatchesRaw(accountId: String, batchIds: String? = nil, count: String? = nil, startPosition: String? = nil, status: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_batch"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
        let URLString = DocuSignAPI.basePath + path
        ...
        return apiClient.send(.GET, headers: headers, to: URI(string: URLString)) { request in
            ...
            try request.query.encode(QueryParams(batchIds: batchIds, count: count, startPosition: startPosition, status: status))
    ...
    /**
     ...
     - parameter startPosition: (query) The position within the total result set from which to start returning values. The value **thumbnail** may be used to return the page image. (optional)
     - parameter status: (query) The status of the item. (optional)
     - returns: `EventLoopFuture` of `BulkSendV2BatchGetBulkSendBatches`
     */
    open class func bulkSendV2BatchGetBulkSendBatches(accountId: String, batchIds: String? = nil, count: String? = nil, startPosition: String? = nil, status: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2BatchGetBulkSendBatches> {
        return bulkSendV2BatchGetBulkSendBatchesRaw(accountId: accountId, batchIds: batchIds, count: count, startPosition: startPosition, status: status, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2BatchGetBulkSendBatches in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BulkSendBatchSummaries.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendBatchSummaries.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BulkSendBatchSummaries.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendBatchSummaries.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - parameter bulkSendListId: (path) The GUID of the bulk send list. This property is created after you post a new bulk send list.
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2CRUDDeleteBulkSendListRaw(accountId: String, bulkSendListId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_lists/{bulkSendListId}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
        let bulkSendListIdPreEscape = String(describing: bulkSendListId)
        let bulkSendListIdPostEscape = bulkSendListIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{bulkSendListId}", with: bulkSendListIdPostEscape, options: .literal, range: nil)
        let URLString = DocuSignAPI.basePath + path
    ...
    /**
     ...
     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - parameter bulkSendListId: (path) The GUID of the bulk send list. This property is created after you post a new bulk send list.
     - returns: `EventLoopFuture` of `BulkSendV2CRUDDeleteBulkSendList`
     */
    open class func bulkSendV2CRUDDeleteBulkSendList(accountId: String, bulkSendListId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2CRUDDeleteBulkSendList> {
        return bulkSendV2CRUDDeleteBulkSendListRaw(accountId: accountId, bulkSendListId: bulkSendListId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2CRUDDeleteBulkSendList in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BulkSendingListSummaries.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingListSummaries.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BulkSendingListSummaries.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingListSummaries.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2CRUDGetBulkSendListRaw(accountId: String, bulkSendListId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_lists/{bulkSendListId}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - parameter bulkSendListId: (path) The GUID of the bulk send list. This property is created after you post a new bulk send list.
     - returns: `EventLoopFuture` of `BulkSendV2CRUDGetBulkSendList`
     */
    open class func bulkSendV2CRUDGetBulkSendList(accountId: String, bulkSendListId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2CRUDGetBulkSendList> {
        return bulkSendV2CRUDGetBulkSendListRaw(accountId: accountId, bulkSendListId: bulkSendListId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2CRUDGetBulkSendList in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BulkSendingList.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingList.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BulkSendingList.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingList.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2CRUDGetBulkSendListsRaw(accountId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_lists"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
        let URLString = DocuSignAPI.basePath + path
    ...
    /**
     ...
     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - returns: `EventLoopFuture` of `BulkSendV2CRUDGetBulkSendLists`
     */
    open class func bulkSendV2CRUDGetBulkSendLists(accountId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2CRUDGetBulkSendLists> {
        return bulkSendV2CRUDGetBulkSendListsRaw(accountId: accountId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2CRUDGetBulkSendLists in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BulkSendingListSummaries.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingListSummaries.defaultContentType)), raw: response)
            case 400:
    ...
    /**
     ...
     - parameter accountId: (path) The id of the account.
     - parameter bulkSendingList: (body)  (optional)
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2CRUDPostBulkSendListRaw(accountId: String, bulkSendingList: BulkSendingList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_lists"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter accountId: (path) The id of the account.
     - parameter bulkSendingList: (body)  (optional)
     - returns: `EventLoopFuture` of `BulkSendV2CRUDPostBulkSendList`
     */
    open class func bulkSendV2CRUDPostBulkSendList(accountId: String, bulkSendingList: BulkSendingList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2CRUDPostBulkSendList> {
        return bulkSendV2CRUDPostBulkSendListRaw(accountId: accountId, bulkSendingList: bulkSendingList, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2CRUDPostBulkSendList in
            switch response.status.code {
            case 201:
                return .http201(value: try response.content.decode(BulkSendingList.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingList.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BulkSendingList.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingList.defaultContentType)), raw: response)
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2CRUDPutBulkSendListRaw(accountId: String, bulkSendListId: String, bulkSendingList: BulkSendingList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_lists/{bulkSendListId}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter bulkSendListId: (path) The GUID of the bulk send list. This property is created after you post a new bulk send list.
     - parameter bulkSendingList: (body)  (optional)
     - returns: `EventLoopFuture` of `BulkSendV2CRUDPutBulkSendList`
     */
    open class func bulkSendV2CRUDPutBulkSendList(accountId: String, bulkSendListId: String, bulkSendingList: BulkSendingList? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2CRUDPutBulkSendList> {
        return bulkSendV2CRUDPutBulkSendListRaw(accountId: accountId, bulkSendListId: bulkSendListId, bulkSendingList: bulkSendingList, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2CRUDPutBulkSendList in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BulkSendingList.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendingList.defaultContentType)), raw: response)
            case 400:
    ...
    /**
     ...
     - parameter accountId: (path) The external account number (int) or account ID GUID.
     - parameter bulkSendListId: (path) The GUID of the bulk send list. This property is created after you post a new bulk send list.
     - parameter bulkSendRequest: (body)  (optional)
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2SendPostBulkSendRequestRaw(accountId: String, bulkSendListId: String, bulkSendRequest: BulkSendRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_lists/{bulkSendListId}/send"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
        let bulkSendListIdPreEscape = String(describing: bulkSendListId)
    ...
    /**
     ...
     - parameter bulkSendListId: (path) The GUID of the bulk send list. This property is created after you post a new bulk send list.
     - parameter bulkSendRequest: (body)  (optional)
     - returns: `EventLoopFuture` of `BulkSendV2SendPostBulkSendRequest`
     */
    open class func bulkSendV2SendPostBulkSendRequest(accountId: String, bulkSendListId: String, bulkSendRequest: BulkSendRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2SendPostBulkSendRequest> {
        return bulkSendV2SendPostBulkSendRequestRaw(accountId: accountId, bulkSendListId: bulkSendListId, bulkSendRequest: bulkSendRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2SendPostBulkSendRequest in
            switch response.status.code {
            case 201:
                return .http201(value: try response.content.decode(BulkSendResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendResponse.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BulkSendResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendResponse.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func bulkSendV2TestPostBulkSendTestRequestRaw(accountId: String, bulkSendListId: String, bulkSendRequest: BulkSendRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/bulk_send_lists/{bulkSendListId}/test"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
        let bulkSendListIdPreEscape = String(describing: bulkSendListId)
    ...
    /**
     ...
     - parameter bulkSendListId: (path) The GUID of the bulk send list. This property is created after you post a new bulk send list.
     - parameter bulkSendRequest: (body)  (optional)
     - returns: `EventLoopFuture` of `BulkSendV2TestPostBulkSendTestRequest`
     */
    open class func bulkSendV2TestPostBulkSendTestRequest(accountId: String, bulkSendListId: String, bulkSendRequest: BulkSendRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BulkSendV2TestPostBulkSendTestRequest> {
        return bulkSendV2TestPostBulkSendTestRequestRaw(accountId: accountId, bulkSendListId: bulkSendListId, bulkSendRequest: bulkSendRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BulkSendV2TestPostBulkSendTestRequest in
            switch response.status.code {
            case 201:
                return .http201(value: try response.content.decode(BulkSendTestResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendTestResponse.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BulkSendTestResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BulkSendTestResponse.defaultContentType)), raw: response)
            }
        }
    }
}
