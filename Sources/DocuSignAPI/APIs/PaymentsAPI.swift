...
open class PaymentsAPI {
     ...
     */
    open class func billingPaymentsGetPaymentRaw(accountId: String, paymentId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func billingPaymentsGetPayment(accountId: String, paymentId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BillingPaymentsGetPayment> {
        return billingPaymentsGetPaymentRaw(accountId: accountId, paymentId: paymentId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BillingPaymentsGetPayment in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BillingPaymentItem.self, using: Configuration.contentConfiguration.requireDecoder(for: BillingPaymentItem.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BillingPaymentItem.self, using: Configuration.contentConfiguration.requireDecoder(for: BillingPaymentItem.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func billingPaymentsGetPaymentListRaw(accountId: String, fromDate: String? = nil, toDate: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func billingPaymentsGetPaymentList(accountId: String, fromDate: String? = nil, toDate: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BillingPaymentsGetPaymentList> {
        return billingPaymentsGetPaymentListRaw(accountId: accountId, fromDate: fromDate, toDate: toDate, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BillingPaymentsGetPaymentList in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(BillingPaymentsResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BillingPaymentsResponse.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BillingPaymentsResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BillingPaymentsResponse.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func billingPaymentsPostPaymentRaw(accountId: String, billingPaymentRequest: BillingPaymentRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/billing_payments"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func billingPaymentsPostPayment(accountId: String, billingPaymentRequest: BillingPaymentRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<BillingPaymentsPostPayment> {
        return billingPaymentsPostPaymentRaw(accountId: accountId, billingPaymentRequest: billingPaymentRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> BillingPaymentsPostPayment in
            switch response.status.code {
            case 201:
                return .http201(value: try response.content.decode(BillingPaymentResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BillingPaymentResponse.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(BillingPaymentResponse.self, using: Configuration.contentConfiguration.requireDecoder(for: BillingPaymentResponse.defaultContentType)), raw: response)
            }
        }
    }
}
