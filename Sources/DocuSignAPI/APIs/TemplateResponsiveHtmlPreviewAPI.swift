...
open class TemplateResponsiveHtmlPreviewAPI {
     ...
     */
    open class func responsiveHtmlPostTemplateResponsiveHtmlPreviewRaw(accountId: String, templateId: String, documentHtmlDefinition: DocumentHtmlDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func responsiveHtmlPostTemplateResponsiveHtmlPreview(accountId: String, templateId: String, documentHtmlDefinition: DocumentHtmlDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ResponsiveHtmlPostTemplateResponsiveHtmlPreview> {
        return responsiveHtmlPostTemplateResponsiveHtmlPreviewRaw(accountId: accountId, templateId: templateId, documentHtmlDefinition: documentHtmlDefinition, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> ResponsiveHtmlPostTemplateResponsiveHtmlPreview in
