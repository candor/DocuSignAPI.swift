...
open class TemplatesAPI {
     ...
     */
    open class func notificationGetTemplatesTemplateIdNotificationRaw(accountId: String, templateId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func notificationGetTemplatesTemplateIdNotification(accountId: String, templateId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<NotificationGetTemplatesTemplateIdNotification> {
        return notificationGetTemplatesTemplateIdNotificationRaw(accountId: accountId, templateId: templateId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> NotificationGetTemplatesTemplateIdNotification in
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func notificationPutTemplatesTemplateIdNotificationRaw(accountId: String, templateId: String, templateNotificationRequest: TemplateNotificationRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates/{templateId}/notification"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func notificationPutTemplatesTemplateIdNotification(accountId: String, templateId: String, templateNotificationRequest: TemplateNotificationRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<NotificationPutTemplatesTemplateIdNotification> {
        return notificationPutTemplatesTemplateIdNotificationRaw(accountId: accountId, templateId: templateId, templateNotificationRequest: templateNotificationRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> NotificationPutTemplatesTemplateIdNotification in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(Notification.self, using: Configuration.contentConfiguration.requireDecoder(for: Notification.defaultContentType)), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func pagesDeleteTemplatePageRaw(accountId: String, documentId: String, pageNumber: String, templateId: String, pageRequest: PageRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func pagesDeleteTemplatePage(accountId: String, documentId: String, pageNumber: String, templateId: String, pageRequest: PageRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesDeleteTemplatePage> {
        return pagesDeleteTemplatePageRaw(accountId: accountId, documentId: documentId, pageNumber: pageNumber, templateId: templateId, pageRequest: pageRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesDeleteTemplatePage in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func pagesGetTemplatePageImageRaw(accountId: String, documentId: String, pageNumber: String, templateId: String, dpi: String? = nil, maxHeight: String? = nil, maxWidth: String? = nil, showChanges: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func pagesGetTemplatePageImage(accountId: String, documentId: String, pageNumber: String, templateId: String, dpi: String? = nil, maxHeight: String? = nil, maxWidth: String? = nil, showChanges: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesGetTemplatePageImage> {
        return pagesGetTemplatePageImageRaw(accountId: accountId, documentId: documentId, pageNumber: pageNumber, templateId: templateId, dpi: dpi, maxHeight: maxHeight, maxWidth: maxWidth, showChanges: showChanges, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesGetTemplatePageImage in
            switch response.status.code {
            case 200:
    ...
    open class func pagesGetTemplatePageImages(accountId: String, documentId: String, templateId: String, count: String? = nil, dpi: String? = nil, maxHeight: String? = nil, maxWidth: String? = nil, nocache: String? = nil, showChanges: String? = nil, startPosition: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesGetTemplatePageImages> {
        return pagesGetTemplatePageImagesRaw(accountId: accountId, documentId: documentId, templateId: templateId, count: count, dpi: dpi, maxHeight: maxHeight, maxWidth: maxWidth, nocache: nocache, showChanges: showChanges, startPosition: startPosition, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesGetTemplatePageImages in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func pagesPutTemplatePageImageRaw(accountId: String, documentId: String, pageNumber: String, templateId: String, pageRequest: PageRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates/{templateId}/documents/{documentId}/pages/{pageNumber}/page_image"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func pagesPutTemplatePageImage(accountId: String, documentId: String, pageNumber: String, templateId: String, pageRequest: PageRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesPutTemplatePageImage> {
        return pagesPutTemplatePageImageRaw(accountId: accountId, documentId: documentId, pageNumber: pageNumber, templateId: templateId, pageRequest: pageRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesPutTemplatePageImage in
            switch response.status.code {
            case 200:
                return .http200(value: (), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func templatesDeleteTemplatePartRaw(accountId: String, templateId: String, templatePart: String, groupInformation: GroupInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func templatesDeleteTemplatePart(accountId: String, templateId: String, templatePart: String, groupInformation: GroupInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<TemplatesDeleteTemplatePart> {
        return templatesDeleteTemplatePartRaw(accountId: accountId, templateId: templateId, templatePart: templatePart, groupInformation: groupInformation, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> TemplatesDeleteTemplatePart in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func templatesGetTemplateRaw(accountId: String, templateId: String, include: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func templatesGetTemplate(accountId: String, templateId: String, include: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<TemplatesGetTemplate> {
        return templatesGetTemplateRaw(accountId: accountId, templateId: templateId, include: include, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> TemplatesGetTemplate in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(EnvelopeTemplate.self, using: Configuration.contentConfiguration.requireDecoder(for: EnvelopeTemplate.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(EnvelopeTemplate.self, using: Configuration.contentConfiguration.requireDecoder(for: EnvelopeTemplate.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func templatesGetTemplatesRaw(accountId: String, count: String? = nil, createdFromDate: String? = nil, createdToDate: String? = nil, folderIds: String? = nil, folderTypes: String? = nil, fromDate: String? = nil, include: String? = nil, isDownload: String? = nil, modifiedFromDate: String? = nil, modifiedToDate: String? = nil, order: String? = nil, orderBy: String? = nil, searchFields: String? = nil, searchText: String? = nil, sharedByMe: String? = nil, startPosition: String? = nil, templateIds: String? = nil, toDate: String? = nil, usedFromDate: String? = nil, usedToDate: String? = nil, userFilter: String? = nil, userId: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func templatesGetTemplates(accountId: String, count: String? = nil, createdFromDate: String? = nil, createdToDate: String? = nil, folderIds: String? = nil, folderTypes: String? = nil, fromDate: String? = nil, include: String? = nil, isDownload: String? = nil, modifiedFromDate: String? = nil, modifiedToDate: String? = nil, order: String? = nil, orderBy: String? = nil, searchFields: String? = nil, searchText: String? = nil, sharedByMe: String? = nil, startPosition: String? = nil, templateIds: String? = nil, toDate: String? = nil, usedFromDate: String? = nil, usedToDate: String? = nil, userFilter: String? = nil, userId: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<TemplatesGetTemplates> {
        return templatesGetTemplatesRaw(accountId: accountId, count: count, createdFromDate: createdFromDate, createdToDate: createdToDate, folderIds: folderIds, folderTypes: folderTypes, fromDate: fromDate, include: include, isDownload: isDownload, modifiedFromDate: modifiedFromDate, modifiedToDate: modifiedToDate, order: order, orderBy: orderBy, searchFields: searchFields, searchText: searchText, sharedByMe: sharedByMe, startPosition: startPosition, templateIds: templateIds, toDate: toDate, usedFromDate: usedFromDate, usedToDate: usedToDate, userFilter: userFilter, userId: userId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> TemplatesGetTemplates in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(EnvelopeTemplateResults.self, using: Configuration.contentConfiguration.requireDecoder(for: EnvelopeTemplateResults.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(EnvelopeTemplateResults.self, using: Configuration.contentConfiguration.requireDecoder(for: EnvelopeTemplateResults.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func templatesPostTemplatesRaw(accountId: String, envelopeTemplate: EnvelopeTemplate? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func templatesPostTemplates(accountId: String, envelopeTemplate: EnvelopeTemplate? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<TemplatesPostTemplates> {
        return templatesPostTemplatesRaw(accountId: accountId, envelopeTemplate: envelopeTemplate, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> TemplatesPostTemplates in
            switch response.status.code {
            case 201:
                return .http201(value: try response.content.decode(TemplateSummary.self, using: Configuration.contentConfiguration.requireDecoder(for: TemplateSummary.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(TemplateSummary.self, using: Configuration.contentConfiguration.requireDecoder(for: TemplateSummary.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func templatesPutTemplateRaw(accountId: String, templateId: String, envelopeTemplate: EnvelopeTemplate? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates/{templateId}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func templatesPutTemplate(accountId: String, templateId: String, envelopeTemplate: EnvelopeTemplate? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<TemplatesPutTemplate> {
        return templatesPutTemplateRaw(accountId: accountId, templateId: templateId, envelopeTemplate: envelopeTemplate, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> TemplatesPutTemplate in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(TemplateUpdateSummary.self, using: Configuration.contentConfiguration.requireDecoder(for: TemplateUpdateSummary.defaultContentType)), raw: response)
            case 400:
                return .http400(value: try response.content.decode(ErrorDetails.self, using: Configuration.contentConfiguration.requireDecoder(for: ErrorDetails.defaultContentType)), raw: response)
            default:
                return .http0(value: try response.content.decode(TemplateUpdateSummary.self, using: Configuration.contentConfiguration.requireDecoder(for: TemplateUpdateSummary.defaultContentType)), raw: response)
            }
        }
    }
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func templatesPutTemplatePartRaw(accountId: String, templateId: String, templatePart: String, groupInformation: GroupInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/templates/{templateId}/{templatePart}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func templatesPutTemplatePart(accountId: String, templateId: String, templatePart: String, groupInformation: GroupInformation? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<TemplatesPutTemplatePart> {
        return templatesPutTemplatePartRaw(accountId: accountId, templateId: templateId, templatePart: templatePart, groupInformation: groupInformation, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> TemplatesPutTemplatePart in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(GroupInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: GroupInformation.defaultContentType)), raw: response)
            case 400:
