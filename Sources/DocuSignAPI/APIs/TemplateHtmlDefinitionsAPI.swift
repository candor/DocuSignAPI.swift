...
open class TemplateHtmlDefinitionsAPI {
     ...
     */
    open class func responsiveHtmlGetTemplateHtmlDefinitionsRaw(accountId: String, templateId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func responsiveHtmlGetTemplateHtmlDefinitions(accountId: String, templateId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ResponsiveHtmlGetTemplateHtmlDefinitions> {
        return responsiveHtmlGetTemplateHtmlDefinitionsRaw(accountId: accountId, templateId: templateId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> ResponsiveHtmlGetTemplateHtmlDefinitions in
