...
open class EnvelopesAPI {
     ...
     */
    open class func auditEventsGetAuditEventsRaw(accountId: String, envelopeId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func auditEventsGetAuditEvents(accountId: String, envelopeId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<AuditEventsGetAuditEvents> {
        return auditEventsGetAuditEventsRaw(accountId: accountId, envelopeId: envelopeId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> AuditEventsGetAuditEvents in
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func envelopesGetEnvelopeRaw(accountId: String, envelopeId: String, advancedUpdate: String? = nil, include: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func envelopesGetEnvelope(accountId: String, envelopeId: String, advancedUpdate: String? = nil, include: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<EnvelopesGetEnvelope> {
        return envelopesGetEnvelopeRaw(accountId: accountId, envelopeId: envelopeId, advancedUpdate: advancedUpdate, include: include, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> EnvelopesGetEnvelope in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func envelopesGetEnvelopesRaw(accountId: String, acStatus: String? = nil, block: String? = nil, cdseMode: String? = nil, continuationToken: String? = nil, count: String? = nil, customField: String? = nil, email: String? = nil, envelopeIds: String? = nil, exclude: String? = nil, folderIds: String? = nil, folderTypes: String? = nil, fromDate: String? = nil, fromToStatus: String? = nil, include: String? = nil, includePurgeInformation: String? = nil, intersectingFolderIds: String? = nil, lastQueriedDate: String? = nil, order: String? = nil, orderBy: String? = nil, powerformids: String? = nil, queryBudget: String? = nil, requesterDateFormat: String? = nil, searchText: String? = nil, startPosition: String? = nil, status: String? = nil, toDate: String? = nil, transactionIds: String? = nil, userFilter: String? = nil, userId: String? = nil, userName: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func envelopesPostEnvelopesRaw(accountId: String, cdseMode: String? = nil, changeRoutingOrder: String? = nil, completedDocumentsOnly: String? = nil, mergeRolesOnDraft: String? = nil, envelopeDefinition: EnvelopeDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/envelopes"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func envelopesPostEnvelopes(accountId: String, cdseMode: String? = nil, changeRoutingOrder: String? = nil, completedDocumentsOnly: String? = nil, mergeRolesOnDraft: String? = nil, envelopeDefinition: EnvelopeDefinition? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<EnvelopesPostEnvelopes> {
        return envelopesPostEnvelopesRaw(accountId: accountId, cdseMode: cdseMode, changeRoutingOrder: changeRoutingOrder, completedDocumentsOnly: completedDocumentsOnly, mergeRolesOnDraft: mergeRolesOnDraft, envelopeDefinition: envelopeDefinition, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> EnvelopesPostEnvelopes in
            switch response.status.code {
            case 201:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func envelopesPutEnvelopeRaw(accountId: String, envelopeId: String, advancedUpdate: String? = nil, resendEnvelope: String? = nil, envelope: Envelope? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/envelopes/{envelopeId}"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func envelopesPutEnvelope(accountId: String, envelopeId: String, advancedUpdate: String? = nil, resendEnvelope: String? = nil, envelope: Envelope? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<EnvelopesPutEnvelope> {
        return envelopesPutEnvelopeRaw(accountId: accountId, envelopeId: envelopeId, advancedUpdate: advancedUpdate, resendEnvelope: resendEnvelope, envelope: envelope, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> EnvelopesPutEnvelope in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func envelopesPutStatusRaw(accountId: String, acStatus: String? = nil, block: String? = nil, count: String? = nil, email: String? = nil, envelopeIds: String? = nil, fromDate: String? = nil, fromToStatus: String? = nil, startPosition: String? = nil, status: String? = nil, toDate: String? = nil, transactionIds: String? = nil, userName: String? = nil, envelopeIdsRequest: EnvelopeIdsRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func envelopesPutStatus(accountId: String, acStatus: String? = nil, block: String? = nil, count: String? = nil, email: String? = nil, envelopeIds: String? = nil, fromDate: String? = nil, fromToStatus: String? = nil, startPosition: String? = nil, status: String? = nil, toDate: String? = nil, transactionIds: String? = nil, userName: String? = nil, envelopeIdsRequest: EnvelopeIdsRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<EnvelopesPutStatus> {
        return envelopesPutStatusRaw(accountId: accountId, acStatus: acStatus, block: block, count: count, email: email, envelopeIds: envelopeIds, fromDate: fromDate, fromToStatus: fromToStatus, startPosition: startPosition, status: status, toDate: toDate, transactionIds: transactionIds, userName: userName, envelopeIdsRequest: envelopeIdsRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> EnvelopesPutStatus in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(EnvelopesInformation.self, using: Configuration.contentConfiguration.requireDecoder(for: EnvelopesInformation.defaultContentType)), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func notificationGetEnvelopesEnvelopeIdNotificationRaw(accountId: String, envelopeId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func notificationGetEnvelopesEnvelopeIdNotification(accountId: String, envelopeId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<NotificationGetEnvelopesEnvelopeIdNotification> {
        return notificationGetEnvelopesEnvelopeIdNotificationRaw(accountId: accountId, envelopeId: envelopeId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> NotificationGetEnvelopesEnvelopeIdNotification in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func notificationPutEnvelopesEnvelopeIdNotificationRaw(accountId: String, envelopeId: String, envelopeNotificationRequest: EnvelopeNotificationRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/envelopes/{envelopeId}/notification"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func notificationPutEnvelopesEnvelopeIdNotification(accountId: String, envelopeId: String, envelopeNotificationRequest: EnvelopeNotificationRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<NotificationPutEnvelopesEnvelopeIdNotification> {
        return notificationPutEnvelopesEnvelopeIdNotificationRaw(accountId: accountId, envelopeId: envelopeId, envelopeNotificationRequest: envelopeNotificationRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> NotificationPutEnvelopesEnvelopeIdNotification in
            switch response.status.code {
            case 200:
                return .http200(value: try response.content.decode(Notification.self, using: Configuration.contentConfiguration.requireDecoder(for: Notification.defaultContentType)), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func pagesDeletePageRaw(accountId: String, documentId: String, envelopeId: String, pageNumber: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func pagesDeletePage(accountId: String, documentId: String, envelopeId: String, pageNumber: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesDeletePage> {
        return pagesDeletePageRaw(accountId: accountId, documentId: documentId, envelopeId: envelopeId, pageNumber: pageNumber, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesDeletePage in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func pagesGetPageImageRaw(accountId: String, documentId: String, envelopeId: String, pageNumber: String, dpi: String? = nil, maxHeight: String? = nil, maxWidth: String? = nil, showChanges: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func pagesGetPageImage(accountId: String, documentId: String, envelopeId: String, pageNumber: String, dpi: String? = nil, maxHeight: String? = nil, maxWidth: String? = nil, showChanges: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesGetPageImage> {
        return pagesGetPageImageRaw(accountId: accountId, documentId: documentId, envelopeId: envelopeId, pageNumber: pageNumber, dpi: dpi, maxHeight: maxHeight, maxWidth: maxWidth, showChanges: showChanges, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesGetPageImage in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func pagesGetPageImagesRaw(accountId: String, documentId: String, envelopeId: String, count: String? = nil, dpi: String? = nil, maxHeight: String? = nil, maxWidth: String? = nil, nocache: String? = nil, showChanges: String? = nil, startPosition: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func pagesGetPageImages(accountId: String, documentId: String, envelopeId: String, count: String? = nil, dpi: String? = nil, maxHeight: String? = nil, maxWidth: String? = nil, nocache: String? = nil, showChanges: String? = nil, startPosition: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesGetPageImages> {
        return pagesGetPageImagesRaw(accountId: accountId, documentId: documentId, envelopeId: envelopeId, count: count, dpi: dpi, maxHeight: maxHeight, maxWidth: maxWidth, nocache: nocache, showChanges: showChanges, startPosition: startPosition, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesGetPageImages in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func pagesPutPageImageRaw(accountId: String, documentId: String, envelopeId: String, pageNumber: String, pageRequest: PageRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/envelopes/{envelopeId}/documents/{documentId}/pages/{pageNumber}/page_image"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func pagesPutPageImage(accountId: String, documentId: String, envelopeId: String, pageNumber: String, pageRequest: PageRequest? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<PagesPutPageImage> {
        return pagesPutPageImageRaw(accountId: accountId, documentId: documentId, envelopeId: envelopeId, pageNumber: pageNumber, pageRequest: pageRequest, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> PagesPutPageImage in
            switch response.status.code {
            case 200:
                return .http200(value: (), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func recipientsGetRecipientInitialsImageRaw(accountId: String, envelopeId: String, recipientId: String, includeChrome: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func recipientsGetRecipientInitialsImage(accountId: String, envelopeId: String, recipientId: String, includeChrome: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<RecipientsGetRecipientInitialsImage> {
        return recipientsGetRecipientInitialsImageRaw(accountId: accountId, envelopeId: envelopeId, recipientId: recipientId, includeChrome: includeChrome, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> RecipientsGetRecipientInitialsImage in
            switch response.status.code {
            case 200:
                return .http200(value: Data(buffer: response.body ?? ByteBuffer()), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func recipientsGetRecipientSignatureRaw(accountId: String, envelopeId: String, recipientId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func recipientsGetRecipientSignature(accountId: String, envelopeId: String, recipientId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<RecipientsGetRecipientSignature> {
        return recipientsGetRecipientSignatureRaw(accountId: accountId, envelopeId: envelopeId, recipientId: recipientId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> RecipientsGetRecipientSignature in
            switch response.status.code {
            case 200:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func recipientsGetRecipientSignatureImageRaw(accountId: String, envelopeId: String, recipientId: String, includeChrome: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
    ...
    open class func recipientsGetRecipientSignatureImage(accountId: String, envelopeId: String, recipientId: String, includeChrome: String? = nil, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<RecipientsGetRecipientSignatureImage> {
        return recipientsGetRecipientSignatureImageRaw(accountId: accountId, envelopeId: envelopeId, recipientId: recipientId, includeChrome: includeChrome, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> RecipientsGetRecipientSignatureImage in
            switch response.status.code {
            case 200:
                return .http200(value: Data(buffer: response.body ?? ByteBuffer()), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func recipientsPutRecipientInitialsImageRaw(accountId: String, envelopeId: String, recipientId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/envelopes/{envelopeId}/recipients/{recipientId}/initials_image"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func recipientsPutRecipientInitialsImage(accountId: String, envelopeId: String, recipientId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<RecipientsPutRecipientInitialsImage> {
        return recipientsPutRecipientInitialsImageRaw(accountId: accountId, envelopeId: envelopeId, recipientId: recipientId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> RecipientsPutRecipientInitialsImage in
            switch response.status.code {
            case 200:
                return .http200(value: (), raw: response)
            case 400:
    ...
    /**
     ...
     - returns: `EventLoopFuture` of `ClientResponse`
     */
    open class func recipientsPutRecipientSignatureImageRaw(accountId: String, envelopeId: String, recipientId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<ClientResponse> {
        var path = "/v2.1/accounts/{accountId}/envelopes/{envelopeId}/recipients/{recipientId}/signature_image"
        let accountIdPreEscape = String(describing: accountId)
        let accountIdPostEscape = accountIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{accountId}", with: accountIdPostEscape, options: .literal, range: nil)
    ...
    open class func recipientsPutRecipientSignatureImage(accountId: String, envelopeId: String, recipientId: String, headers: HTTPHeaders = DocuSignAPI.customHeaders, beforeSend: (inout ClientRequest) throws -> Void = { _ in }) -> EventLoopFuture<RecipientsPutRecipientSignatureImage> {
        return recipientsPutRecipientSignatureImageRaw(accountId: accountId, envelopeId: envelopeId, recipientId: recipientId, headers: headers, beforeSend: beforeSend).flatMapThrowing { response -> RecipientsPutRecipientSignatureImage in
            switch response.status.code {
            case 200:
                return .http200(value: (), raw: response)
            case 400:
