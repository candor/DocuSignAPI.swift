...
let accountId = "accountId_example" // String | The external account number (int) or account ID GUID.
let workspace = workspace(billableAccountId: "billableAccountId_example", callerInformation: nil, created: "created_example", createdByInformation: nil, lastModified: "lastModified_example", lastModifiedByInformation: nil, settings: nil, status: "status_example", workspaceBaseUrl: "workspaceBaseUrl_example", workspaceDescription: "workspaceDescription_example", workspaceId: "workspaceId_example", workspaceName: "workspaceName_example", workspaceUri: "workspaceUri_example") // Workspace |  (optional)
