...
**powerForms** | [[**PowerForm**](PowerForm.md)] | An array of PowerForm objects that contain information about any PowerForms that are included in the template. | [optional] 
